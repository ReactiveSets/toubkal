  ...
  it 'after images_dataset.add( objects ), expect images.fetch_all() to be equal to result', ( done ) ->
    ...
    images.on( 'complete', ->
      expect( images.fetch_all() ).to.be.eql [
        { id: 1 , title: 'Villa Marrakech 2' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/02.jpg' }
        { id: 2 , title: 'Villa Marrakech 3' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/03.jpg' }
        { id: 3 , title: 'Villa Marrakech 4' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/04.jpg' }
        { id: 4 , title: 'Villa Marrakech 5' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/05.jpg' }
        { id: 5 , title: 'Villa Marrakech 7' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/07.jpg' }
        { id: 6 , title: 'Villa Marrakech 8' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/08.jpg' }
      ]
  ...
  it 'after images_dataset.add( objects ), expect images.fetch_all() to be equal to result', ( done ) ->
    ...
    images.on( 'complete', ->
      expect( images.fetch_all() ).to.be.eql [
        ...
        { id: 5 , title: 'Villa Marrakech 7' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/07.jpg' }
        { id: 6 , title: 'Villa Marrakech 8' , src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/08.jpg' }
        { id: 7 , title: 'Villa Marrakech 12', src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/12.jpg' }
        { id: 8 , title: 'Villa Marrakech 13', src: 'https://raw.github.com/ConnectedSets/castorcad/master/images/13.jpg' }
      ]
