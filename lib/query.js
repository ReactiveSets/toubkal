  ...
  */
  Query.evaluate = function( value, attribute, expression ) {
    ...
    if ( expression instanceof Array ) {
      ...
      return object_literal( value, expression )
    }
    
    function object_literal( value, object ) {
      // ToDo: Object literal
              ...
              default:
                ...
                if ( operator ) {
                  var f = operator[ 0 ]
                    ...
                    , accepts_fail = options && options.accepts_fail
                    , parameters
                    , _left = left
                  ;
