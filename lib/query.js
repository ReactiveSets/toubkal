...
( function( exports ) {
  ...
  */
  ...
  // Date operators
  Operator( 'Date', function( _, year, month, day, hours, minutes, seconds, miliseconds ) {
    var d;
    
    switch( arguments.length ) {
      case 1: d = new Date(); break
      case 2: d = new Date( year ); break
      case 3: d = new Date( year, month ); break
      case 4: d = new Date( year, month, day ); break
      case 5: d = new Date( year, month, day, hours ); break
      case 6: d = new Date( year, month, day, hours, minutes ); break
      case 7: d = new Date( year, month, day, hours, minutes, seconds ); break
      default: d = new Date( year, month, day, hours, minutes, seconds, miliseconds ); break
    }
  ...
  Operator( 'hours', function( date ) {
    return date instanceof Date ? date.getHours() : fail;
  } );
