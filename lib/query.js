...
( function( exports ) {
  ...
  */
  Query.evaluate = function( value, attribute, expression ) {
    ...
    return evaluate( expression, that.__ ) === fail ? false: true;
    
    function evaluate( expression, left ) {
      if ( expression instanceof Array ) {
        ...
        while ( i < expression.length ) {
          ...
          switch( type ) {
            ...
            case 'object': // this is a subexpression
              ...
              left = evaluate( first, left );
            break;
            
            case 'string': // this is an operator
              switch( first ) {
                case 'failed':
                  skip = ! ( left = left === fail ? true: fail );
                break;
                ...
                default:
                  ...
                  if ( operator ) {
                    ...
                    if ( ! options.do_not_evaluate_parameters ) {
                      ...
                      for ( var j = 0, l = parameters.length; ++j < l; ) {
                        ...
                        if ( typeof v == 'object' && v instanceof Array ) {
                          parameters[ j ] = left = evaluate( v, that.__ );
        ...
        left = evaluate_object( expression, left );
      }
      
      return left;
      
      function evaluate_object( object, value ) {
        var __ = that.__; // save that.__
        
        for ( var a in object ) {
          if ( object.hasOwnProperty( a ) ) {
            var v = value[ a ], e = object[ a ];
            ...
            switch( toString.call( e ) ) {
              ...
              case '[object Array]':
                left = evaluate( e, that.__ = v );
              break;
              
              case '[object Object]':
                left = evaluate_object( e, v );
              break;
            }
  ...
  */
  ...
  Operator( '$', function( _, right ) {
    return right;
  }, { do_not_evaluate_parameters: true } );
  
  Operator( [ 'and', '&&' ], function( _, right ) {
    return right;
  } );
  
  Operator( [ 'not', '!' ], function( _, right ) {
