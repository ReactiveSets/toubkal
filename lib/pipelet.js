...
( function( exports ) {
  ...
  Plug.subclass( Input, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       ToDo: tests for remove_source and _remove_destination
    */
  ...
  Plug.subclass( Output, {
    ...
    */
    _fetch_all: function( receiver, query ) {
      ...
      out || receiver || this.error( '_fetch_all', 'is asynchronous and no receiver function was provided' );
  ...
  Root.subclass( Pipelet, {
    ...
    */
    ...
    _add_destination: function( d, options ) {
      this._output._add_destination( d._input || d, options );
      
      return this;
    }, // _add_destination()
    
    _remove_destination: function( d, options ) {
      this._output._remove_destination( d._input || d, options );
  ...
  * /
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     _fetch_all                     none         Redirected by Pipelet to _output._fetch_all
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     Example:
       ...
       rs.loop( tmp )._output._add_destination( tmp._input );
