...
( function( exports ) {
  ...
  */
  ...
  // ToDo: Create Input class for Pipelets. This will ease encapsulation, documentation, and implementation of additional control inputs
  
  // ToDo: Document Output class
  function Output( pipelet ) {
    Query_Tree.call( this );
  ...
  extend_2( subclass( Query_Tree, Output ).prototype, {
    /* ------------------------------------------------------------------------
    ...
    */
    _get_name: function( method ) {
      return this.pipelet._get_name( method );
    }, // _get_name()
    ...
    */
    _fetch: function( receiver, query ) {
      ...
      function rx( values, no_more ) {
        if ( values && values.length ) values = that.pipelet.__transform( values, {}, 'fetch' );
    ...
    */
    ...
    __fetch_source_all: function( receiver, query ) {
      ...
      if ( out === u && receiver === u ) p._error( 'fetch_source_all', 'is asynchronous and no receiver function was provided' );
      
      return out;
      
      // ToDo: dry code with _fetch_all()#rx_concat()
      function rx_concat( values, no_more ) {
        if ( out ) p._error( 'fetch_source_all', 'received extra chunck after no_more' );
    ...
    // ToDo: document _query_update() and __update_upstream_query()
    // ToDo: move to Output
    _query_update: function( removes, adds, destination ) {
      // ToDo: guaranty synchronization between _fetch() and _query_update()
      
      var rl = removes.length, al = adds.length;
      
      de&&ug( this._get_name( '_query_update' )
        + log.s( { removes: removes, adds: adds, destination: destination._get_name() } )
      );
      
      rl && this.remove( removes, destination );
      al && this.add   ( adds   , destination );
      
      return this.pipelet.__update_upstream_query( removes, adds );
    }, // _query_update()
    
    emit: function( operation, values, options ) {
      var subscribers_operations = this.route( operation, values );
  ...
  extend_2( p, {
    ...
    */
    ...
    __fetch_source: function( receiver, query ) {
      this._output.__fetch_source( receiver, query );
      
      return this;
    },
    
    __fetch_source_all: function( receiver, query ) {
      this._output.__fetch_source_all( receiver, query );
      
      return this;
    },
    
    _query_update: function( removes, adds, destination ) {
      this.__output._query_update( removes, adds, destination );
    ...
    */
    __add_source_query: function( source ) {
      ...
      output && output._query_update( [], q ? q.query : [], this );
    ...
    */
    ...
    __update_upstream_query: function( removes, adds ) {
      ...
      if ( removes.length || adds.length ) {
        ...
        source && source._output._query_update( removes, adds, this );
  ...
  * /
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     _query_update              this --> output
     
     __update_upstream_query        null         Called by _query_update()
     
     _pause_destination         this --> output
     _resume_destination        this --> output
  */
  ...
  Pipelet.Build( 'encapsulate', Encapsulate, {
    ...
    _query_update: function( removes, adds, destination ) {
      this._output._query_update( removes, adds, destination );
    ...
    /*
     _pause_destination: function( destination ) {
      return this._output._pause_destination( destination );
    },
     
     _resume_destination: function( destination ) {
      return this._output._resume_destination( destination );
    },*/
  ...
  */
  function Controllet( options ) {
    ...
    output._query_update = this._query_update;
  ...
  Pipelet.subclass( Controllet, function( Super ) {
    return {
      ...
      // Route _query_update to this source
      _query_update: function( removes, adds, destination ) {
        var p = this.pipelet, rl = removes.length, al = adds.length;
        
        de&&ug( p._get_name( '_query_update' )
          + log.s( { removes: removes, adds: adds, destination: destination._get_name() } )
        );
        ...
        if ( rl || al ) {
          ...
          source && source._query_update( removes, adds, destination );
        }
        
        return this;
      } //  Controllet.._query_update()
    ...
    */
    ...
    _query_update: function( removes, adds, destination ) {
      ...
      if ( rl || al ) {
        ...
        while ( ++i < l ) sources[ i ]._output._query_update( removes, adds, destination );
      }
  ...
  */
  function Dispatch( source, branches, branch_dataflow, options ) {
    ...
    branches // ToDo: implement branches using a proper pipelet input port instead of _on() + _fetch(), see filter.js for example
  ...
  */
  function Trace( name, options ) {
    ...
    this._output.__fetch_source = this.__fetch_source;
    this._output._query_update = this._query_update;
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    __fetch_source: function( receiver, query ) {
      ...
      if ( s ) {
        Output.prototype.__fetch_source.call( this, rx, query );
      } else {
    ...
    _query_update: function( removes, adds, destination ) {
      this.pipelet.log( '_query_update', { removes : removes, adds: adds, destination: destination._get_name() } );
      
      return Output.prototype._query_update.call( this, removes, adds, destination );
    }, // _query_update()
  ...
  */
  ...
  Pipelet.Build( 'delay', Delay, {
    __fetch_source: function( receiver, query ) {
      ...
      setTimeout( function() {
        Output.prototype.__fetch_source.call( that, _receiver, query )
      }, delay );
      
      return this;
    }, // __fetch_source()
    
    // ToDo: add delay on _query_update()
