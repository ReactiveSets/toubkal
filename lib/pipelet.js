/*  pipelet.js
    ...
    Pipelet core classes:
      ...
      - Plug / Input / Output / Query_Tree_Output
...
( function( exports ) {
  ...
  */
  function Input( p, name ) {
    ...
    // incomming transactions by source
  ...
  Plug.subclass( Input, {
    ...
    // ToDo: Document source_transactions_add()
    source_transactions_add: function( transaction_id, source ) {
      // Check if this input has its source_transactions set for this
      var source_transactions = this.source_transactions
        , source_transaction  = source_transactions[ transaction_id ]
        , j, sl
      ;
      /*
        For each transaction_id, source_transaction is an Array of Objects with attributes:
        - source: (Output) source of the transaction
        - position: (Integer) of the input into the transaction Array at the source output
      */
      ...
      if ( source_transaction ) {
        ...
        for ( j = -1, sl = source_transaction.length; ++j < sl; ) {
          if ( source_transaction[ j ].source === source ) return null; // already added
        }
        ...
        // ToDo: add tests for transactions with multiple sources
        source_transaction = source_transactions[ transaction_id ] = [];
      }
    ...
    // ToDo: Document source_transactions_remove()
    ...
    // ToDo: complete verification of source_transactions_remove_source() and call on Input..__remove_source(); document
    source_transactions_remove_source: function( source ) {
      ...
      for ( transaction_id in source_transactions ) {
        ...
        for ( var i = -1, s; s = source_transaction[ ++i ]; ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     Query_Tree_Output( pipelet, name )
     
     A query tree output plug.
  */
  function Query_Tree_Output( pipelet, name ) {
    Output.call( this, pipelet, name );
  ...
  Output.subclass( Query_Tree_Output, {
    ...
    add_destination_to_transaction: function( transaction, input, transaction_id ) {
      // ToDo: move this documentation to more appropriate location
      ...
      /* 
         If a transaction happens over two or more branches that later rejoin
         ...
         transaction at the join, the same transaction id will start and stop
         twice (or more) at the join.
         ...
         level, a pipelet typically has no way to know in advance if such a
         ...
         seen from all upstream branches.
         
         To allow other transactions to be created within each branch, a
         diamond transaction tag could be added before the diamond, added
         to all transactions.
         
         Transporting this tag militates for a transaction Object in options
         that would embed the transaction id, the more flag, and the tags,
         e.g. options: {
           transaction: {
             id: '...'
             more: true
         ...
         If there are multiple diamonds nested in a graph, multiple tags
         could be added, then removed by recombining unions.
         
         Example graph:
         
           var top = source.tag_transactions( 'diamond' )
             , branch_1 = top...
             , branch_2 = top...
             , branch_3 = top...
           ;
           
           xs.union( [ branch_1, branch_2, branch_3 ], { transaction_tag: 'diamond' } );
         
         The union removes the 'diamond' tag from transactions' tags.
         
         For this to work, all branches must also forward the transaction
         even if they have nothing else to forward. This will be accomplished
         for all tagged transactions.
      */
    ...
    dummy: false // ToDo: remove dummy when done
  } ); // Query_Tree_Output instance methods
  ...
  */
  function Pipelet( options ) {
    ...
    this._input  || ( this._input  = new Input( this ) );
    this._output || ( this._output = new Query_Tree_Output( this ) );
  ...
  */
  Pipelet.subclass = function( constructor, methods ) {
    subclass( this, constructor, methods );
  ...
  */
  ...
  Controllet.Input = Input.subclass(
    function( p, name ) { Input.call( this, p, name ) }, {
  ...
  Controllet.Output = Query_Tree_Output.subclass(
    function( p, name ) { Query_Tree_Output.call( this, p, name ) }, {
  ...
  */
  ...
  Set.Output = Query_Tree_Output.subclass(
    function( p, name ) { Query_Tree_Output.call( this, p, name ) }, {
  ...
  */
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    _input_add_source: function( source ) {
      ...
      return Input.prototype._add_source.call( this, source );
    }, // _input_add_source()
    ...
    __input_fetch_source: function( receiver, query ) {
      ...
      if ( s ) {
        Input.prototype.__fetch_source.call( this, rx, query );
      } else {
    ...
    _output_query_update: function( removes, adds, input ) {
      ...
      return Query_Tree_Output.prototype.query_update.call( this, removes, adds, input );
  ...
  */
  ...
  Pipelet.Build( 'delay', Delay, {
    __input_fetch_source: function( receiver, query ) {
      ...
      setTimeout( function() {
        Input.prototype.__fetch_source.call( that, _receiver, query )
      }, delay );
    ...
    _output_query_update: function() {
      ...
      setTimeout( function() {
        Query_Tree_Output.prototype.query_update.apply( that, arguments )
      }, this.delay );
  ...
  */
  XS.add_exports( {
    ...
    'Input'            : Input,
    'Output'           : Output,
    'Query_Tree_Output': Query_Tree_Output,
    'Pipelet'          : Pipelet,
