...
( function( exports ) {
  ...
  Plug.subclass( Input, {
    ...
    */
    _insert_source_union: function( name ) {
      ...
      union._input._add_source( source );
      
      union._output._add_destination( this.pipelet, no_fetch );
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     Example:
       ...
       xs.loop( tmp )._output._add_destination( tmp );
  ...
  extend_2( Dispatch.prototype, {
    ...
    create_branches: function( new_branches, options ) {
      ...
      for ( var i = -1, l = new_branches.length; ++i < l; ) {
        ...
        output && output._output._add_destination( this.gatherer );
  ...
  */
  function Greedy( options ) {
    this._output || ( this._output = new Greedy.Output( this, 'greedy_out' ) );
  ...
  Greedy.Output = Pipelet.Output.subclass(
    function( p, name ) { Pipelet.Output.call( this, p, name ) }, {
    
    /* -----------------------------------------------------------------------------------------
       update_upstream_query( removes, adds )
       
       Pipelet default behavior: Updates this pipelet input query and propagate uptream.
