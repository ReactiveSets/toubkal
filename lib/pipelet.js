  ...
  extend_2( Query.prototype, {
    ...
    */
    ...
    /* -----------------------------------------------------------------------------------------
      ...
      These expressions should have been added previously with Query..add() or an exception is
      triggered.
    ...
    */
    remove: function( q1 ) {
      ...
      // ToDo: optimize this to avoid reconstructing the entire query to process remaining optimized-out expressions
      var q = new Query( this.query ).clear_operations().add( this.optimized );
      
      this.query     = q.query;
      this.optimized = q.optimized;
      
      push.apply( this.adds   , q.adds );
      push.apply( this.removes, q.removes );
