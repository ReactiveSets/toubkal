  ...
  */
  ...
  extend_2( Transaction.prototype, {
    ...
    set_source_options: function( options ) {
      ...
      if ( this.count || this.source_more || ! this.ending ) return this;
      
      // This transaction had not ended because it was waiting for the source to have
      // no-more to send
  ...
  */
  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    ...
    _fetch_source_destination: function( source ) {
    ...
    */
    remove_source: function( source, options ) {
      ...
      if ( ! ( options && options.no_fetch ) && source._transactional_fetch ) {
        source._transactional_fetch( this, this._query && this._query.query, { operation: 'remove' } );
      }
