...
( function( exports ) {
  ...
  */
  // ToDo: provide get_transaction() function to prevent the systematic use of new Transaction()
  function Transaction( transactions, count, options, pipelet ) {
    ...
    if ( options ) {
      if ( t = options.__t ) {
        ...
        de&&ug( 'new Transaction(), adding ' + count + ' operations to nested transaction, new total:' + t.count );
    ...
    return init_transaction.call( this );
    
    function init_transaction() {
      // Initialize Hidden class
      this.count          = count;
      this.source_options = options;
      this.emit_options   = o || options;
      this.o              = extend_2( { __t: this }, this.emit_options );
  ...
  extend_2( Transaction.prototype, {
    ...
    emit: function( operation, values ) {
      var options = this.get_emit_options();
