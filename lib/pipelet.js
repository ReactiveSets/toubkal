...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     ToDo: Query() review documentation bellow this line.
    ...
    */
    ...
    /* -----------------------------------------------------------------------------------------
       ...
       Behavior:
         ...
         there is no need to keep both expression, and the least restrictive (the one resulting
       ...
       Optimized Examples:
         ...
         new Query( [ { flow: 'store', id: 1465 } ] ).add( [ { flow: 'store' } ] )
           ...
           In a future version, it is possible that we might consider optimizing adds by removing
           expressions removed. If we implement this optimization, 'adds' and 'removes' final
           state would be strictly identical. 
