...
( function( exports ) {
  ...
  */
  ...
  Query_Tree.Transaction = Transaction;
  ...
  */
  function Pipelet( options ) {
    ...
    // ToDo: make query tree a contrained object rather than a base or embedded class
    this.__init_query_tree();
    
    // __query_tree_emit() transactions
  ...
  extend( p, Query_Tree.prototype, {
    ...
    */
    ...
    __query_tree_emit: function( operation, values, options ) {
      var subscribers_operations = this.__query_tree_route( operation, values );
      ...
      for ( var i = -1, l = subscribers_operations.length; ++i < l; ) {
        ...
        more || this.__end_transaction( transaction, transaction_id, options );
          ...
          if ( t ) {
            ...
            if ( ! transaction ) {
              if ( more && transaction ) {
                ...
                this.__add_destination_to_transaction( transaction, p, transaction_id );
              }
              
              // ToDo: __query_tree_emit()#_update(): test transaction w/ nesting
              transaction = t.t = new Query_Tree.Transaction( t.count, options );
            }
    ...
    __end_transaction: function( transaction, transaction_id, options ) {
    ...
    __end_source_transactions: function() {
