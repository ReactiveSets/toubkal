  ...
  */
  ...
  Output.subclass( Query_Tree_Output, {
    ...
    emit: function( operation, values, options ) {
      ...
      for ( var i = -1, l = subscribers_operations.length; ++i < l; ) {
        ...
        while ( r = subscribers[ ++j ] ) {
          ...
          if ( t ) {
            // ToDo: r.t is never set so we cannot reach this code, review this section
    ...
    add_destination_to_transaction: function( transaction, input, transaction_id ) {
      ...
      // Preventing these issues would require to stop altering the state of input
    ...
    // ToDo: complete implementation of end_source_transactions() and call on __remove_destination()
