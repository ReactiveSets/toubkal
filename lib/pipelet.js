...
( function( exports ) {
  ...
  */
  ...
  function Pipelet( options ) {
    ...
    // ToDo: rename source, destination, key with leading underscore to prevent conflicts with pipelet names
    this.source = this.destination = null; // No source or destination yet
  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       ToDo: the name plug might intuitively understood as pluging this pipelet into a source, which is what add_source() does, choose better names
    */
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       Parameters:
         ...
         - query (optional): default query is [ {} ], the 'all' query
    */
    _add_destination: function( destination, query ) {
      this.query_tree_add( query || [ {} ], destination );
