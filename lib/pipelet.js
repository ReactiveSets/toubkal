  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    _fetch_source: function( receiver, _query ) {
      ...
      de&&ug( get_name( this ) + 'query: ' + log.s( query ) + ', keys: ' + log.s( keys ) );
    ...
    */
    add_source: function( source ) {
      ...
      if ( source.fetch ) {
        ...
        // !!! use source.fetch(), not _fetch_source() because derived pipelets, such as Union
        // overload fetch() but not _fetch_source()
        
        // ToDo: test and document
        // ToDo allow overloading of the code bellow to allow adding to redirected destinations
        ...
        }/*, this._query.query*/ ); // ToDo: need to be able to fetch with this query, but this does not work with Union redirects, requires overloading of this section in Union
      } else {
