...
( function( exports ) {
  ...
  */
  ...
  function Output_Transaction( transaction_id, source ) {
    this.source = source; // ToDo: source should be an Output_Transactions instance
  ...
  Root.subclass( Output_Transaction, {
    ...
    add_destination: function( input ) {
      ...
      var id = this.id
        , s = input.source_transactions.add( id, this.source )
      ;
    ...
    // ToDo: Document Output_Transaction..end()
      ...
      if ( inputs.length ) {
        ...
        while ( input = inputs[ ++i ] ) {
          ...
          var s = input.source_transactions.remove( id, source );
  ...
  Root.subclass( Output_Transactions, {
    ...
    */
    get: function( tid ) {
      ...
      return transactions[ tid ] || ( transactions[ tid ] = new Output_Transaction( tid, this.source ) );
    }, // get()
