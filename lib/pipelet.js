  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       to another pipelet as done by Controllet.
    */
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       pipelet than this as done by controllets.
  ...
  */
  ...
  Pipelet.subclass( Controllet, function( Super ) {
    return {
      ...
      }, // Controllet.._add_source_destination()
      ...
      }, // Controllet.._remove_source_destination()
      ...
      }, // Controllet.._fetch_source_destination()
