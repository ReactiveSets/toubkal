...
( function( exports ) {
  ...
  */
  ...
  extend( p, {
    /* ------------------------------------------------------------------------
       get() -- deprecated, use fetch_all instead.
    ...
    */
    fetch_all: function( receiver ) {
      ...
      if ( out === u && receiver === u ) throw new Error( "Pipelet.fetch_all( receiver ) is asynchronous and no receiver function was provided" );
