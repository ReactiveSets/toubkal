...
( function( exports ) {
  ...
  extend_2( p, {
    ...
    */
    __emit: function( event_name, values, options ) {
      ...
      this.__output.emit( event_name, values, options );
    ...
    */
    __fetch_source: function( receiver, _query ) {
      ...
      if ( s && q ) {
        ...
        receiver.call( this, [], true ); // No source, so this is an empty set
      }
      ...
      function rx_filtered( values, no_more ) {
        ...
        if ( no_more || ( values && values.length ) ) receiver.call( that, values, no_more );
      } // rx_filtered()
    ...
    */
    _fetch_all: function( receiver, query ) {
      ...
      function rx_all( values, no_more ) {
        ...
        receiver && receiver.call( that, out, no_more );
      } // rx_all()
    ...
    */
    __add_source_query: function( source ) {
      ...
      source._query_update && source._query_update( [], q ? q.query : [], this );
    ...
    */
    ...
    _query_update: function( removes, adds, destination ) {
      ...
      rl && this.__output.remove( removes, destination );
      al && this.__output.add   ( adds   , destination );
    ...
    __update_upstream_query: function( removes, adds ) {
      ...
      if ( removes.length || adds.length ) {
        ...
        source && source._query_update( removes, adds, this );
    ...
    return {
      ...
      _query_update: function( removes, adds, destination ) {
        ...
        if ( rl || al ) {
          ...
          source._query_update && source._query_update( removes, adds, destination );
        }
    ...
    */
    _fetch: function( receiver, query ) {
        ...
        function rx( values, no_more ) {
          if ( no_more ) {
            ...
            if ( count ) {
              ...
              source._pause_destination( that );
            } else {
      ...
      function resume_all_sources( source ) {
        for ( var i = -1, l = sources.length; ++i < l; ) {
          sources[ i ]._resume_destination( that );
        }
      } // resume_all_sources()
    ...
    _query_update: function( removes, adds, destination ) {
      ...
      if ( rl || al ) {
        ...
        while ( ++i < l ) sources[ i ]._query_update( removes, adds, destination );
      }
  ...
  */
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    _query_update: function( removes, adds, destination ) {
      this.log( '_query_update', { removes : removes, adds: adds, destination: destination._get_name() } );
      
      return Pipelet.prototype._query_update.call( this, removes, adds, destination );
    }, // _query_update()
