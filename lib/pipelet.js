    ...
    */
    _add_source: function( source, options ) {
      ...
      return source.is_void ? this : this
        .__add_source              ( source ) // May return a union, source of this
        .__add_source_destination  ( source )
        .__add_source_query        ( source )
        .__fetch_source_destination( source, options )
      ;
      
      // ToDo: should we force return this, or let return union?
    }, // _add_source()
    ...
    __add_source: function( source ) {
      ...
      if ( s ) {
        ...
        this.__add_source = function( source ) {
          ...
          return union.__add_source( source ); // this is a friend of this union
        };
