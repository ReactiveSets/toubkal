...
( function( exports ) {
  ...
  */
  ...
  var Query_Tree_Prototype = {
    ...
    query_tree_route: function( operation, values, options ) {
      var top = this.query_tree_top;
  ...
  */
  ...
  // Query_Tree is a subclass of Pipelet
  // Must be defined after build
  Pipelet.subclass( Query_Tree, Query_Tree_Prototype );
