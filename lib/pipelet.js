...
( function( exports ) {
  ...
  */
  ...
  extend( subclass( Output, Query_Tree_Output ).prototype, Query_Tree.prototype, {
  ...
  */
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    _query_update: function( removes, adds, destination ) {
      ...
      return Query_Tree_Output.prototype._query_update.call( this, removes, adds, destination );
    }, // _query_update()
