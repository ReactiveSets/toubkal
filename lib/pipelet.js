  ...
  /* -------------------------------------------------------------------------------------------
     ...
     Parameters:
       ...
       - context / constructor : used to call composition, if this is a function it is used
                                 as a class constructor which instance is the context.
     
     Example, Compose a filter with an aggregate:     
       1/ Create the composition:
         function aggregate_from( in, from, measures, dimensions, options ) {
           return in
             .filter( from, options )
       ...
       2/ Use composed aggregate_from() to aggregates sales yearly from usa:
