  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    fetch: function( receiver, query ) {
      ...
      if ( query ) { // ToDo: fetch() complete query code, or remove if done in _subscribe()
        var query_tree = this.query_tree;
        
        query_tree || ( query_tree = this.query_tree = this.query_tree() );
        
        query_tree.add( query, subscriber );
    ...
    */
    add_source: function( source, options ) {
      ...
      function add_source_destination() {
        source._add_destination && source._add_destination( that, that._query );
    ...
    */
    _add_source: function( source ) {
      ...
      if ( s ) {
        this.source = s = xs
          .union()
          ._add_destination( this, this._query ) // ToDo: add test
          ._add_source( s )
        ;
    ...
    */
    remove_source: function( source, options ) {
      ...
      source._remove_destination && source._remove_destination( this, this._query );
