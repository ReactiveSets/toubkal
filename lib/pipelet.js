...
( function( exports ) {
  ...
  extend_2( subclass( Plug, Input ).prototype, {
    ...
    */
    __fetch_source: function( receiver, _query ) {
      ...
      if ( s && q ) {
        ...
        if ( 1 == ql && 0 == keys[ 0 ].length ) {
          ...
          // ToDo: optimize nul query; also perform this._query AND _query before fetching source, removing the need for rx_filtered() bellow
          var filter = q.filter;
    ...
    __fetch_source_all: function( receiver, query ) {
      var that = this, p = this.pipelet, chunks = [], out, u;
  ...
  */
  ...
  extend_2( p, {
    ...
    */
    ...
    // ToDo: remove _fetch_all() bridge function when _output integration is complete
    _fetch_all: function( receiver, query ) {
    ...
    */
    _add_source: function( source, options ) {
      ...
      // if ( source._output ) source = source._output;
    ...
    */
    __add_source_destination: function( source ) {
      ...
      output && output.__add_destination( this );
    ...
    */
    __remove_source_destination: function( source ) {
      ...
      output && output.__remove_destination( this );
    ...
    */
    __add_source_query: function( source ) {
      var q = this._query, output = source._output;
      
      output && output.query_update( [], q ? q.query : [], this );
    ...
    */
    __fetch_source_destination: function( source, options ) {
      ...
      if ( output ) {
        output._transactional_fetch( this, q && q.query, options );
      } else {
  ...
  */
  ...
  Pipelet.Build( 'encapsulate', Encapsulate, {
    ...
    _add_destination: function( destination, options ) {
      return this._output_pipelet._add_destination( destination, options );
    },
    
    _remove_destination: function( destination, options ) {
      return this._output_pipelet._remove_destination( destination, options );
    },
    
    // Input source addition and removal
    _add_source: function( source, options ) {
      this._input_pipelet._add_source( source, options );
      
      return this;
    },
    
    _remove_source: function( source, options ) {
      this._input_pipelet._remove_source( source, options );
  ...
  */
  ...
  Pipelet.subclass( Controllet, function( Super ) {
    return {
      ...
      _is_lazy: function() {
        var i = -1, destinations = this._output.destinations, d;
      ...
      __add_source_query: function( source ) {
        ...
        var i = -1, destinations = this._output.destinations, d, name;
  ...
  */
  ...
  Controllet.Build( 'union', Union, {
    ...
    */
    _fetch: function( receiver, query ) {
      var p = this.pipelet, sources = p._sources, l = sources.length;
    ...
    query_update: function( removes, adds, destination ) {
      ...
      if ( rl || al ) {
        var sources = p._sources, l = sources.length, i = -1;
  ...
  */
  function Trace( name, options ) {
    ...
    this._output.query_update = this.query_update;
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    __fetch_source: function( receiver, query ) {
      var u, s = this.pipelet._source, that = this, name = '__fetch_source', p = this.pipelet;
