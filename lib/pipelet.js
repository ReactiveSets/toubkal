...
( function( exports ) {
  ...
  extend( p = Tee.prototype, {
    ...
    */
    ...
    _add_destination: function( d ) {
      if ( this.destinations.indexOf( d ) !== -1 ) throw new Error( "Tee, _add_destination(), invalid destination: already there" );
  ...
  */
  ...
  /* --------------------------------------------------------------------------
     module exports
  */
  eval( XS.export_code( 'XS', [ 'Pipelet', 'Tee', 'Set', 'xs' ] ) );
