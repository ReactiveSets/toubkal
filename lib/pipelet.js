    ...
    */
    ...
    add_query_source: function( filter, options ) {
      ...
      if ( ! p ) {
        ...
        var q = this._query = new Query( [] ).generate(); // nul filter
        ...
        if ( ! this._lazy ) {
          ...
          source.fetch( function( values, no_more ) {
            ...
            if ( no_more ) {
              ...
              de&&ug( 'Query changed, fetched source, added: ' + added.length + ', removed: ' + removed.length );
