    ...
    */
    add_source: function( source ) {
      ...
      if ( source._transactional_fetch ) {
        ...
        // ToDo: how about fetching such as source? Do we still need to support this? What's the use case? Do we have a test case?
        // ToDo: filter using this._query
        this.add( source );
      }
  ...
  */
  ...
  Pipelet.subclass( Controller, ( function( Super ) {
    return {
      ...
      }, // Union.._remove_source_destination()
  ...
  } )( Pipelet.prototype ) ); // Controller instance methods
