  ...
  Plug.subclass( Input, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       Parameters:
       - source: (Array of Objects, Output, or Pipelet) to add as a source to
         this Input. If a pipelet is provided, the output used will be
         source._output.
    ...
    */
    _add_source: function( source, options ) {
      ...
      var output = source instanceof Output ? source : source._output;
      ...
      if ( output ) {
        ...
        this
          .__add_source_query        ( output ) // May be overloaded (Controllet)
          .__add_source              ( output )
          .__fetch_source_destination( output, options )
        ;
      } else {
    ...
    /* ------------------------------------------------------------------------
       ...
       Parameters:
       - source: (Array of Objects, Output, or Pipelet) the source to remove
    ...
    */
    _remove_source: function( source, options ) {
      ...
      if ( output ) {
        ...
        this
          .__fetch_source_destination       ( output, options )
          .__remove_source                  ( output )
          .source_transactions_remove_source( output )
  ...
  function Union( sources, options ) {
    ...
    if ( sources ) {
      for( var i = -1; ++i < sources.length; ) {
        ...
        if ( source ) input._add_source( source );
      }
    }
  } // Union()
