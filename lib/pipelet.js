     ...
     Returns an Object with attributes:
       - more: (Boolean):
         - true : input options had a "truly" property "more" and/or a "transaction_id"
                  property
         - undefined: no input options, no property "more", or "falsy" property "more"
       ...
       - _t (optional Object): transaction Object shallow copied from options, if present
         - more (optional Interger): true is more data is expected in this transaction
    ...
    */
    __fetch_source_destination: function( source, options ) {
      ...
      if ( output ) {
        ...
        p[ ( options && options.operation ) || '_add' ]( source, only_more( options ) );
      }
