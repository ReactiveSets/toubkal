    ...
    */
    ...
    _update_upstream_query: function( adds, removes ) {
      ...
      if ( q === Query.pass_all ) {
        ...
        de&&ug( this._get_name()
          + '._update_upstream_query(), replace pass_all query by nul query, source: '
          + ( source ? source._get_name() : 'none' )
        );
      ...
      if ( removes.length || adds.length ) {
        de&&ug( this._get_name() + '._update_upstream_query(), update source: '
          + ( source ? source._get_name() : 'none' )
        );
