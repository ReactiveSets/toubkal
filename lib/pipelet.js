...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     - position: (Integer) of the input into the transaction Array at the
       source output.
  */
  function Source_Transactions() {
    this.transactions = Dictionary();
  }
  
  XS.Root.subclass( Source_Transactions, {
    /* ------------------------------------------------------------------------
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       - Object: objact that was returned by add()
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       - Object: the object returned by source_transactions..add()
       ...
       ToDo: add tests for Source_Transactions..remove_source()
    */
    remove_source: function( source ) {
      var transactions = this.transactions
        , transaction_id, transaction
        , name = de && 'Source_Transactions..remove_source(), '
      ...
      for ( transaction_id in transactions ) {
        ...
        for ( var i = 0, s; s = transaction[ i ]; ) {
          ...
          // ToDo: this should use an Output_Transactions object:
    ...
    } // Source_Transactions..remove_source()
  } ); // Source_Transactions instance attributes
  ...
  */
  function Input( p, name ) {
    ...
    this.source_transactions = new Source_Transactions();
  } // Input()
  ...
  Plug.subclass( Input, {
    ...
    */
    source_transactions_remove_source: function( source ) {
      var terminated_transactions_objects = this.source_transactions.remove_source( source )
        , name = de && this._get_name( 'source_transactions_remove_source' )
        , i = -1, t
      ;
  ...
  Plug.subclass( Output, {
    ...
    */
    ...
    add_destination_to_transaction: function( transaction, input, transaction_id ) {
      ...
      var source = input.source_transactions.add( transaction_id, this );
    ...
    remove_destination_from_transaction: function( transaction, input, transaction_id ) {
      ...
      var source = input.source_transactions.remove( transaction_id, this );
    ...
    end_source_transaction: function( transaction, transaction_id, options ) {
      ...
      while ( input = transaction[ ++i ] ) {
        ...
        if ( input.source_transactions.remove( transaction_id, this ) ) {
