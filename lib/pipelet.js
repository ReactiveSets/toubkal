  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    _fetch_source: function( receiver ) {
      var s = this._source, q = this._query, query = q.query, ql = query.length;
    ...
    */
    ...
    _update_upstream_query: function( adds, removes ) {
      ...
      if ( q === Query.pass_all ) {
        ...
        de&&ug( '_update_upstream_query(), replace pass_all query by nul query' );
  ...
  */
  function Dispatch( source, branches, branch_dataflow, options ) {
    ...
    var that = this
      ...
      , gatherer   = this.gatherer   = xs.union( options, { name: 'gatherer' } )
    ;
    ...
    _fetch_source: function( receiver ) {
      ...
      if ( s ) {
        Pipelet.prototype._fetch_source.call( this, function( values, no_more ) {
          that.log( 'fetch(), received', { values: values, no_more: no_more } );
          
          receiver( values, no_more );
        } );
      } else {
        this.log( 'fetch(), no source', { values: [], no_more: true } );
