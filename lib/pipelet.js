  ...
  extend( p, Query_Tree_Prototype, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       ToDo: Allow receiver to receive all historical operations (adds and
       removes) for version control.
    */
    ...
    */
    add_source: function( source ) {
      ...
      if ( q ) {
        ...
        // ToDo: source has no reference to this, this could be a problem for disconnecting pipelets from source
      }
