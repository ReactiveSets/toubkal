    ...
    */
    update: function( updated, options ) {
      ...
      if ( l === 1 ) {
        ...
        removed = this.transform( [ update[ 0 ] ], options, 'remove' );
        added   = this.transform( [ update[ 1 ] ], options, 'add'    );
        ...
        removed = this.transform( updated.removed, options, 'remove' );
        added   = this.transform( updated.added  , options, 'add'    );
