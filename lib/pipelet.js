...
( function( exports ) {
  ...
  */
  ...
  XS.Transactions = subclass( Dictionary, Transactions );
  ...
  extend( Transactions.prototype, {
    ...
    get_transaction: function( count, options, pipelet ) {
      ...
      if ( options ) {
        if ( t = options.__t ) return t.add_operations( count ); // nested transaction within this pipelet
        ...
        if ( tid = options.transaction_id ) {
          ...
          if ( options.more || count > 1 ) {
            ...
            return this.transactions[ tid ] = new Transaction( count, options, pipelet ); 
          }
        }
      }
    ...
    end_transaction: function( t ) {
      if ( ! t.is_closed() && t.end().is_closed() ) {
        var tid = t.get_tid();
        
        de&&ug( 'Transactions..end_transaction(), tid: ' + tid );
        
        if ( tid ) delete this.transactions[ tid ];
      }
  ...
  */
  function Transaction( count, options, pipelet ) {
    ...
    this.source_more    = options && options.more;
    this.emit_options   = o;
  ...
  extend_2( Transaction.prototype, {
    ...
    add_operations: function( count ) {
      ...
      de&&ug( 'Transaction..add_operations(), adding ' + count + ' operations, new total: ' + this.count );
    ...
    */
      ...
      if ( this.count || this.source_more ) return this;
