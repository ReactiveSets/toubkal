...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     An input plug.
  */
  function Input( pipelet, name ) {
    Plug.call( this, pipelet, name || 'in' );
  ...
  extend_2( subclass( Plug, Input ).prototype, {
    /* ------------------------------------------------------------------------
    ...
    */
    _add_source: function( source, options ) {
      ...
      if ( output ) {
        // ToDo: use this instead of this.pipelet to allow direct connection to this input
        output.__add_destination( this.pipelet );
    ...
    */
    _remove_source: function( source, options ) {
      ...
      if ( output ) {
        ...
        output.__remove_destination( this.pipelet );
      }
    ...
    */
    __add_source_query: function( output ) {
      ...
      q && output.query_update( [], q.query, this.pipelet );
    ...
    */
    ...
    update_upstream_query: function( removes, adds ) {
      ...
      if ( removes.length || adds.length ) {
        ...
        source && source._output.query_update( removes, adds, this.pipelet );
  ...
  */
  ...
  extend_2( subclass( Plug, Output ).prototype, {
    /* ------------------------------------------------------------------------
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       Adds a destination to this output.
       ...
       Exception:
         - destination is already added to this output
    */
    __add_destination: function( destination ) {
      ...
      if ( i != -1 ) this.error( '__add_destination', 'already added, destination: ' + destination._get_name() );
    ...
    */
    __remove_destination: function( destination ) {
      // Remove this destination from of this.destinations
      var destinations = this.destinations
        , i = destinations.indexOf( destination )
      ;
  ...
  */
  ...
  XS.Query_Tree_Output = Query_Tree_Output;
  
  extend_2( subclass( Output, Query_Tree_Output ).prototype, {
    // ToDo: implement add and remove methods updating upstream query
    
    // ToDo: document query_update() and __update_upstream_query()
    query_update: function( removes, adds, destination ) {
      ...
      rl && tree.remove( removes, destination );
      al && tree.add   ( adds   , destination );
    ...
    emit: function( operation, values, options ) {
      ...
      for ( var i = -1, l = subscribers_operations.length; ++i < l; ) {
        var subscribers_operation = subscribers_operations[ i ]
          , operation = subscribers_operation[ 0 ]
          , subscribers = subscribers_operation[ 1 ]
        ;
        
        var j, l1, r, p, _operation = '_' + operation, clear = operation == 'clear';
        
        more || this.end_transaction( transaction, transaction_id, options );
        
        // Emit all subscribers' values
        for ( j = -1, l1 = subscribers.length; ++j < l1; ) {
          r = subscribers[ j ], p = r.p;
          ...
          if ( t ) {
            ...
            if ( ! transaction ) {
              if ( more && transaction ) {
                ...
                this.add_destination_to_transaction( transaction, p, transaction_id );
              }
    ...
    add_destination_to_transaction: function( transaction, p, transaction_id ) {
      // ToDo: is it possible to have reentrance issues on graph loops?
      // Preventing these issues would require to stop altering the state of p
      
      // Check if this destination pipelet has its source_transactions set for this
      var source_transactions = p._input.source_transactions
    ...
    end_transaction: function( transaction, transaction_id, options ) {
      ...
      if ( l ) {
        ...
        for ( var i = -1, p; ++i < l; ) {
          ...
          // Remove this source from p._input.source_transactions
          ...
          if ( not_found ) {
            try {
              ...
              exception( e, 'emit()/end_transaction()' );
            }
          }
          
          if ( input.source_subscriber_index ) continue; // the transaction will terminate in the subscribers emit
    ...
    /* ToDo: remove unsused, commented-out, function __end_source_transactions()
    end_source_transactions: function() {
      // ToDo: implement and call on _remove_destination()
      var source_transactions = this._input.source_transactions
      ...
      this._input.source_transactions = Dictionary();
  ...
  */
  function Controllet( options ) {
    this._input  || ( this._input  = new Controllet_Input ( this ) );
    this._output || ( this._output = new Controllet_Output( this ) );
  ...
  function Controllet_Input( p, name ) { Input.call( this, p, name ) }
  
  extend_2( subclass( Input, Controllet_Input ).prototype, {
    ...
    _is_lazy: function() {
      var i = -1, destinations = this.pipelet._output.destinations, d;
      
      while( d = destinations[ ++i ] ) {
        if ( d._input._is_lazy() ) continue;
    ...
    __add_source_query: function( output ) {
      ...
      while( d = destinations[ ++i ] ) {
        ...
        d._input.__add_source_query( output );
      }
    ...
    }, // Controllet_Input..__add_source_query()
    ...
    __remove_source_query: function( output, options ) {
      ...
      while( d = destinations[ ++i ] ) {
        ...
        d._input.__remove_source_query( output, options );
      }
    ...
    }, // Controllet_Input..__remove_source_query()
    ...
    __fetch_source_destination: function( source, options ) {
      ...
      while( d = destinations[ ++i ] ) {
        ...
        d._input.__fetch_source_destination( source, options );
      }
    ...
    } // Controllet_Input..__fetch_source_destination()
  } ); // Controllet_Input instance attributes
  
  function Controllet_Output( p, name ) { Query_Tree_Output.call( this, p, name ) }
  
  extend_2( subclass( Query_Tree_Output, Controllet_Output ).prototype, {
    ...
    query_update: function( removes, adds, destination ) {
      ...
      if ( rl || al ) {
        ...
        if( source ) {
          ...
          output && output.query_update( removes, adds, destination );
        }
      }
      
      return this;
    } //  Controllet_Output..query_update()
  } ); // Controllet_Output instance attributes
  ...
  */
  function Union( sources, options ) {
    this._input  || ( this._input  = new Union_Input ( this ) );
    this._output || ( this._output = new Union_Output( this ) );
  ...
  function Union_Input( p, name ) { Controllet_Input.call( this, p, name ) }
  
  extend_2( subclass( Controllet_Input, Union_Input ).prototype, {
    __add_source: function( source ) {
    ...
    __remove_source: function( source ) {
      ...
      return this;
    } // Union_Input..__remove_source()
  } ); // Union_Input instance attributes
  
  function Union_Output( p, name ) { Controllet_Output.call( this, p, name ) }
  
  extend_2( subclass( Controllet_Output, Union_Output ).prototype, {
    /* ------------------------------------------------------------------------
       _fetch( receiver [, query] )
    ...
    */
    ...
    query_update: function( removes, adds, destination ) {
      ...
      if ( rl || al ) {
        ...
        while ( ++i < l ) sources[ i ]._output.query_update( removes, adds, destination );
      }
      
      return this;
    } //  Union_Output..query_update()
  } ); // Union_Output instance attributes
  ...
  */
  ...
  Pipelet.Build( 'trace', Trace, {
    ...
    _output_query_update: function( removes, adds, destination ) {
      this.pipelet.log( 'query_update', { removes : removes, adds: adds, destination: destination._get_name() } );
      
      return Query_Tree_Output.prototype.query_update.call( this, removes, adds, destination );
  ...
  */
  XS.add_exports( {
    ...
    'Controllet_Input' : Controllet_Input,
    'Controllet_Output': Controllet_Output,
    'Union'            : Union,
