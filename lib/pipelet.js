...
( function( exports ) {
    ...
    _add_source: function( source ) {
      ...
      if ( s ) {
        if ( s instanceof Union ) {
          ...
          this.source = this.union( [ s, source ], { _destination: this } );
        }
      } else {
        this.source = source;
      }
    ...
    _add_destination: function( destination ) {
      ...
      if ( d ) {
        if ( d instanceof Fork ) {
          ...
          this.destination = this.fork( [ d, destination ], { _source: this } );
        }
      } else {
  ...
  */
  function Union( sources, options ) {
    var destination = Pipelet.call( this, options ).options._destination;
