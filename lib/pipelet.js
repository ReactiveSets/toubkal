...
( function( exports ) {
  ...
  */
  ...
  XS.Root.subclass( Event_Emitter, {
    /* ------------------------------------------------------------------------
  ...
  */
  ...
  subclass( null, Transactions, {
    ...
    /* ------------------------------------------------------------------------
       get_transaction( count [, options [, output ] ] )
    ...
    */
    get_transaction: function( count, options, output ) {
        ...
        if ( tid ) {
          ...
          if ( more || count > 1 || t.forks ) {
            ...
            return transactions[ tid ]
              = new Transaction( count, options, output )
      ...
      return new Transaction( count, options, output )
        ._on( 'tid', record_tid )
      ;
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     - options (optional Object): upstream options:
  ...
  */
  function Transaction( count, options, pipelet ) {
    ...
    var output = pipelet && pipelet._output || null;
    ...
    // ToDo: this should be an output instead of a pipelet
