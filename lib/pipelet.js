  ...
  Pipelet.subclass( Controllet, function( Super ) {
    return {
      ...
      _add_source_destination: function( source ) {
        ...
        function get_name( that ) {
          return name = that._get_name( '_add_source_destination' );
        }
      ...
      _remove_source_destination: function( source, options ) {
        ...
        function get_name( that ) {
          return name = that._get_name( '_remove_source_destination' );
        }
      ...
      _fetch_source_destination: function( source, options ) {
        ...
        function get_name( that ) {
          return name = that._get_name( '_fetch_source_destination' );
        }
