  ...
  extend( p, Query_Tree_Prototype, {
    ...
    /* ------------------------------------------------------------------------
       ...
       Parameters:
         ...
         - options (Optional Object): options for the transactional fetch
             - more (Boolean): true if there will be more operations after this
                 fetch.
         ...
         - then (Function): optional callback once done fetching all data
    */
    _transactional_fetch: function( receiver_pipelet, query, options, then ) {
      var that = this
      ...
      if ( options ) {
        if ( options.operation ) operation = options.operation;
        
        if ( options.more ) get_options();
      }
      ...
      function receiver( values, no_more ) {
        ...
        if ( no_more ) {
          ...
          if ( transaction ) {
            receiver_pipelet[ operation ]( values, transaction.next().get_emit_options() );
            
            transactions.end_transaction( transaction );
          } else {
            receiver_pipelet[ operation ]( values );
          }
        } else if ( values.length ) {
          receiver_pipelet[ operation ]( values, o || get_options() );
        }
      ...
      function get_options() {
        ...
        transaction = transactions.get_transaction( 2, options || {}, that );
    ...
    */
    add_source: function( source ) {
      ...
      if ( source.fetch ) {
        var that = this, connected, t, o;
        
        de&&ug( this._get_name( 'add_source' ) + 'fetching source: ' + source._get_name() );
        
        // ToDo: test and document
        // ToDo: allow overloading of the code bellow to allow fetch destination's redirection
        
        source._transactional_fetch( this, this._query && this._query.query );
      } else {
