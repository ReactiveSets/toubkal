...
( function( exports ) {
  ...
  */
  ...
  extend( p, {
    /* ------------------------------------------------------------------------
       __get() -- deprecated, use fetch_all instead.
    ...
    */
    __get: function() {
      // use fetch_all: if get can be used fetch_all will be synchronous
    ...
    if ( pipelet === u ) {
      pipelet = ( function() {
        ...
        return function pipelet() {
          var a = Pipelet.set_default_options( this, arguments, constructor );
