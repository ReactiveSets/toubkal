  ...
  extend( p, {
    ...
    */
    update: function( updated, options ) {
      var l = updated.length, removed, added, more = extend( {}, options );
      ...
      if ( l === 1 ) {
        ...
        removed = this.transform( [ update[ 0 ] ], more, 'remove' );
        added   = this.transform( [ update[ 1 ] ], more, 'add'    );
        ...
        removed = this.transform( updated.removed, more, 'remove' );
        added   = this.transform( updated.added  , more, 'add'    );
      ...
      removed.length && this.emit_remove( removed, added_length ? more : options );
