...
( function( exports ) {
  ...
  Pipelet.build( 'union', Union, {
    ...
    */
    fetch: function( receiver ) {
      var sources = this.sources, l = sources.length;
      ...
      if ( l ) {
        for ( var i = -1, count = l; ++i < l; ) {
          ...
          if ( source.fetch ) {
            ...
            // The source should be an array of objects
  ...
  extend( Dispatch.prototype, {
    ...
    remove_branch: function( id ) {
      ...
      if ( branch ) {
        ...
        branch.destination && branch.destination.unplug( this.gatherer, { no_fetch: true } );
        
        // Unplug using no_fetch because there is nowhere to send removes to
        branch.source && this.dispatcher.unplug( branch.source, { no_fetch: true } );
  ...
  */
  eval( XS.export_code( 'XS', [
    'xs', 'Compose', 'Encapsulate', 'Pipelet', 'Fork', 'Union', 'Dispatch', 'Alter', 'Set', 'Unique_Set', 'Trace', 'Delay', 'Query', 'Query_Tree'
  ] ) );
