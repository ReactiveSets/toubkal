...
( function( exports ) {
  ...
  */
  function Pipelet( options ) {
    ...
    this._input  = new Input( this, 'in'  );
    this._output = new Query_Tree_Output( this, 'out' );
  ...
  */
  function Controllet( options ) {
    ...
    // ToDo: derive Input and Output
    input._is_lazy = this._is_lazy;
    input.__add_source_query = this.__add_source_query;
    input.__remove_source_query = this.__remove_source_query;
    input.__fetch_source_destination = this.__fetch_source_destination
    
    output.query_update = this.query_update;
  ...
  Pipelet.subclass( Controllet, function( Super ) {
    return {
      ...
      // ToDo: is that really different from Pipelet.._is_lazy()?
      _is_lazy: function() {
      ...
      query_update: function( removes, adds, destination ) {
        ...
        if ( rl || al ) {
          var source = p._source && p._source._output;
          
          source && source.query_update( removes, adds, destination );
        }
        
        return this;
      } //  Controllet..query_update()
  ...
  */
  function Union( sources, options ) {
    ...
    input.__add_source = this.__add_source;
    input.__remove_source = this.__remove_source;
    
    output._fetch = this._fetch;
    output.query_update = this.query_update;
  ...
  Controllet.Build( 'union', Union, {
    ...
    */
    ...
    __remove_source: function( source ) {
      ...
      if ( ( source = sources.indexOf( source ) ) === -1 ) this.error( "source not found in this" );
  ...
  */
  function Delay( delay, options ) {
    ...
    this._input.__fetch_source = this.__fetch_source;
  ...
  Pipelet.Build( 'delay', Delay, {
    ...
    // ToDo: add delay on query_update()
