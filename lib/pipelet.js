  ...
  Pipelet.Build( 'union', Union, {
    ...
    */
    ...
    _add_destination: function( destination, query ) {
      ...
      return Pipelet.prototype._add_destination.call( this, destination, query );
    ...
    _remove_destination: function( destination, query ) {
      ...
      return Pipelet.prototype._remove_destination.call( this, destination, query );
    ...
    _add_source_destination: function( source ) {
      ...
      var i = -1, destinations = this._destinations, d, name = de && this._get_name( '_add_source_destination' );
      
      de&&ug( name + 'source: ' + source._get_name() );
    ...
    _remove_source_destination: function( source, options ) {
      ...
      var i = -1, destinations = this._destinations, d, name = de && this._get_name( '_remove_source_destination' );
      
      de&&ug( name + 'source: ' + source._get_name() + ', options: ' + log.s( options ) );
