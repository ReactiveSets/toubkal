...
( function( exports ) {
  ...
  */
  ...
  Pipelet.Build( 'form_display_errors', Form_Display_Errors, {
    _transform: function( values, options, caller ) {
      var form        = values[ 0 ]
        , form_node   = this.form
  ...
  Ordered.subclass( Form_Process_Fields, {
    ...
    event_handler: function() {
      var form_process = this.form_process
        , fields       = this.fields instanceof Array ? this.fields : this.a
  ...
  */
  ...
  Ordered.Build( 'form_process', Form_Process, {
    ...
    draw: function() {
      ...
      if( style ) {
        style.submit_button && XS.add_class( button, style.submit_button );
        style.form          && XS.add_class( form  , style.form          );
      }
    ...
    if( form_fields instanceof Array ) {
      ...
      form_fields
        .on( 'complete', function() {
          form_fields.fetch_all( fetch_fields );
        } )
