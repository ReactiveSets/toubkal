    ...
    transform: function( values, options, caller ) {
      ...
      if( caller === 'add' ) {
        for( var spans = form_node.getElementsByTagName( 'span' ), i = spans.length; i; ) {
          ...
          if(  error_style  ) XS.remove_class( container, error_style   );
      ...
      for( var i  = len; i; ) {
        ...
        if(  error_style  ) XS.add_class   ( field_container, error_style   );
  ...
  */
  ...
  Ordered.subclass( Form_Process_Fields, {
    ...
    event_handler: function() {
      ...
      fields instanceof Array ? get_from_value( fields ) : fields.fetch_all( get_from_value );
      
      return;
      
      function get_from_value( fields ) {
        var previous = that.form_value;
  ...
  */
  ...
  Ordered.build( 'form_process', Form_Process, {
    ...
    draw: function() {
      ...
      if( style && style.submit_button ) button.setAttribute( 'class', style.submit_button );
