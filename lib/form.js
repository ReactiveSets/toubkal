  ...
  Ordered.subclass( Form_Process_Fields, {
    ...
    event_handler: function() {
      ...
      for( var i = -1; ++i < len; ) {
        ...
        // set the UUID
        // if( element.name === 'uuid' && element.value === '' ) element.value = uuid.v4();
      ...
      if( elements[ 'uuid' ].value === '' ) {
        ...
        Form_Validate.prototype.add.call( this, [ object ] );
      } else {
        Form_Validate.prototype.update.call( this, [ [ this.form_value, object ] ] );
      }
