  ...
  */
  ...
  Pipelet.build( 'form_validate', Form_Validate, {
    validate: function( fields, object ) {
      ...
      this.emit_add( errors.length ? errors : [ object ] );
    ...
    add: function( added ) {
      ...
      fields instanceof Array 
        ? this.validate( fields, object ) 
        : fields.fetch_all( function( fields ) { that.validate( fields, object ) } )
      ;
    ...
    update: function( updates ) {
      de&&ug( "Form_Validate..update(), updated: " + log.s( updates ) );
      
      var object = updates[ 0 ][ 1 ]
        , fields = this.fields
        , that   = this
      ;
