...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     Form_Process_Fields()
  */
  function Form_Process_Fields( form_fields, form_process, options ) {
  ...
  Ordered.subclass( Form_Process_Fields, {
    ...
    update_: function( at, v ) {
      ...
      u1.label && label( div, u1.label, label_classes );
      
      switch( u1.type ) {
        case 'text' :
        case 'email' :
        case 'phone' :
          input_text( div, u1, input_classes );
        break;
        
        case 'hidden' :
          hidden( div, u1, input_classes );
        break;
        
        case 'radio' :
          radio( div, u1, input_classes );
        break;
        
        case 'checkbox' :
          checkbox( div, u1, input_classes );
        break;
        
        case 'drop_down' :
          drop_down( div, u1, input_classes );
        break;
        
        case 'text_area' :
          text_area( div, u1, input_classes );
        break;
  ...
  */
  function Form_Process( dom_node, model, form_fields, options ) {
    ...
    if( form_fields instanceof Array ) {
      ...
      this.fields = new Form_Process_Fields( form_fields, this, options );
    }
    
    // this.add( form_fields ) if fields are array
    // else Form_Process_Fields
