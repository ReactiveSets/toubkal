...
[ [ 'io', 'socket.io-client' ], '../core/pipelet', './socket_io_crossover', '../util/timestamp_string' ],
...
function( io, rs, Socket_IO_Crossover, timestamp_string ) {
  ...
  */
  var state_changes = rs.set( [], { key: [ 'id', 'address' ], name: 'socket_io_state_changes' } )
    , state_change_id = 0
  ;
  
  Set.Build( 'socket_io_state_changes', function Socket_IO_State_Changes( options ) {
    return state_changes;
    
  }, function( Super ) { return {
  
    _add_value: function( t, value ) {
      Super._add_value.call( this, t, {
