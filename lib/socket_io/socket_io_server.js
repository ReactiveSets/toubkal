...
function( io, rs, Socket_IO_Crossover, timestamp_string ) {
  ...
  /* --------------------------------------------------------------------------
      ...
      This is a @@synchronous, @@greedy, @@stateful @@singleton.
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      - Sane thing with cache resynchronization on hard reconnections:
        ```javascript
          rs
            // connect to server
            .socket_io_server()
            ...
            .cache( rs.socket_io_state_changes().filter( [ { same_id: false } ] ) )
      ...
      This is an @@asynchronous, @@stateless @@multiton.
      ...
      .on( 'rs_connection', function( _connection ) {
        ...
        if ( previous_id ) {
          ...
          if( same_id ) {
            ...
            /*
              Using socket_io_state_changes(), on same_id === false, caches can be resynchronized by:
