  ...
  rs
    ...
    */
    .Singleton( socket_io_synchronizing, function( source, options ) {
      return source
        .pass_through( { tag: synchronizing, transactional: true } ) // never fetch source
        ...
        .alter( function( state ) { delete state.same_id }, { fork_tag: synchronizing, transactional: true } )
      ;
    } )
