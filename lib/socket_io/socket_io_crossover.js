  ...
  function Input_Proxy( pipelet, options ) {
    ...
    this.source = {
      ...
      _fetch: function( receiver, query, query_changes ) {
        pipelet._fetch_receivers[ ++fetch_id ] = receiver;
        
        pipelet._send( [ 'fetch', fetch_id, query, query_changes ] );
      }
    };
  } // Input_Proxy()
      ...
      that.socket = socket
        ...
        .on( 'rs', function( peer_position, operation, _2, _3, _4, _5, _6, _7 ) {
          ...
          try {
            switch( operation ) {
              case 'fetch':
                input._fetch( fetch_receiver, _3 /* query */, _4 /* query_changes */ );
              break;
          ...
          function fetch_receiver( values, no_more ) {
            ...
            that._send( [ 'fetched', _2, no_more, values ].concat( slice.call( arguments, 2, 4 ) ) ); // send first 4 arguments, ignoring terminated source (5th)
          } // fetch_receiver()
