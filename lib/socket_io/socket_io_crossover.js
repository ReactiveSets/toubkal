        ...
        - operation (String):
          ...
          - ```"abort_fetch"```: aborting a previous @@fetch request.
             ...
             *fetched* responses for the corresponding fetch.
             ...
             - **fetch_id** (Number): matching previous fetch request
               *fetch_id* parameter.
      ...
      that.socket = socket
        ...
        .on( 'rs', function( peer_position, operation, _2, _3, _4, _5, _6, _7 ) {
          ...
          try {
            switch( operation ) {
              case 'fetch':
                // ToDo: validate that fetch_id (_2) is greater than previous fetch_id
                if ( fetch_aborts[ _2 ] ) {
                  error( 'received "fetch" with the same id: ' + _2 + ' as an ongoing fetch' );
                } else {
              ...
              case 'abort_fetch':
                ...
                // !! do not an emit error if fetch_abort is not found, it may have just completed
              break;
