    ...
    function start_server( address ) {
      ...
      function on_connection( socket ) {
        ...
        function on_rs_connection( _connection ) {
          ...
          if ( connection ) {
            ...
            connections[ id ]
              ...
              = {
                  ...
                  count         : 1,
                  timeout_object: null,
                  // ToDo: rename socket into crossover
          ...
          // Acknowledge connection request, providing connection id to peer
          // then force (re)transmit queued packets
          connection.socket._connect( _connection );
