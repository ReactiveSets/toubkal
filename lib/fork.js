...
( function( exports ) {
  ...
  extend( Pipelet.prototype, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       This method is typically overloaded by derived classes, the default
       behavior is to only notify downstream pipelets.
       
       Parameters:
         added: Array of object values to add
    */
    add: function( added ) {
      return this.emit_add()( added );
    }, // add()
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       is to only notify downstream pipelets using emit_update().
    ...
    */
    ...
    /* ------------------------------------------------------------------------
       ...
       This method is typically overloaded by derived classes, the default behavior
       is to only notify downstream pipelets using emit_remove().
  ...
  */
  function Tee() {
    ...
    slice.call( arguments, 0 ).forEach( this._add_destination, this );
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     PXXX(): template for pipelet definition.
     
     Connects to its source, builds an empty .out Set and leaves it up for the
     derived class to decide what to do when an add/update/remove operation
     happens.
  */
  function PXXX( source, options ) {
    // Constructor for a destination that depends on what happens to its source
