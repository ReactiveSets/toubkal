...
( function( exports ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
    The xs object is a void source Fork to provide a fluid interface with a
    namespace for other Forks.
  ...
  */
  ...
  // Prevent becoming a source of any downstream Fork, see Fork.prototype.set_source()
  xs.is_void = true;
