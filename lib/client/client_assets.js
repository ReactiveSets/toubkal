...
!function( exports ) {
  ...
  */
  ...
  // Toubkal core
  exports.core = rs.set( [
    { name: 'toubkal/lib/umd_define.js'                   },
    { name: 'toubkal/lib/lap_timer.js'                    },
    { name: 'toubkal/lib/console_logger.js'               },
    { name: 'toubkal/lib/lazy_logger.js'                  },
    { name: 'toubkal/lib/extend.js'                       },
    { name: 'toubkal/lib/rs.js'                           },
    { name: 'toubkal/lib/code.js'                         },
    { name: 'toubkal/lib/query.js'                        },
    { name: 'toubkal/lib/event_emitter.js'                },
  ...
  exports.ui = rs.set( [
    ...
    { name: 'toubkal/lib/client/react.js'                 }
  ] ).require_resolve();
