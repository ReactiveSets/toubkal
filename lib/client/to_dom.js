  ...
  Set.Build( '$to_dom', $TO_DOM, function( Super ) {
    ...
    return {
      ...
      _update_value: function( t, removed, added ) {
        ...
        // ToDo: handle moves from upstream order(), if any
      ...
      _add_value: function( t, value ) {
        ...
        if ( $parent ) {
          if ( ! $node ) {
            ...
            var emit_options = t.source_options
            ...
            if ( locations ) {
              ...
              // ToDo: find a mechanism allowing multiple location changes
              // ToDo: handle moves
              // ToDo: the following should be handled by Transaction..get_emit_options()
              delete t.emit_options.locations;
            } else {
