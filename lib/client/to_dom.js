...
( 'to_dom', [ '../core/pipelet' ], function( rs ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      - render (Function ( Document document, HTMLElement $node, Object value ) -> ): optional
        ...
        - $node (HTMLElement): container element created by to_dom()
  ...
  */
  ...
  /*
     ...
     ToDo: rename to_dom() pipelet into $to_dom()
     ToDo: implement $query_selector() pipelet to use as a pipelet selector input to $to_dom()
