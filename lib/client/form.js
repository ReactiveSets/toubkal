...
*/
undefine()( 'form', [ '../core/order' ], function( rs ) {
  'use strict';
  ...
  /* -------------------------------------------------------------------------------------------
     de&&ug()
  */
  var de = true, ug = RS.log.bind( null, 'form' );
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     A lazy stateless pipelet transforming the input dataset values into form fields
     
     Parameters:
       
       - fields (Array) : array of fields to transform
    
     Example:
     
     rs
       
       .set( [ { id: 1, full_name: 'John Muller', address: 'somewhere in the universe' } ] )
  ...
  */
  ...
  Pipelet.Build( 'values_to_fields', Values_To_Fields, function( Super ) {
    var push = Array.prototype.push;
    
    return {
      __transform: function( values ) {
        var fields = this._fields, out = [];
