    ...
    /* -------------------------------------------------------------------------------------------
        ...
        @parameters:
          ...
          - options (Object): optional pipelet options, plus:
            ...
            - jQuery (Function): if provided, events are registered the following way:
              jQuery( $node ).on( _event_name, function listener() {} )
      ...
      return output = source
        .map( function( value, operation ) {
          ...
          if ( handler ) {
            ...
            if ( operation == 'add' || operation == 'fetch' && $node ) {
              value = extend( {}, value );
