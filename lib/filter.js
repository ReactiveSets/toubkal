  ...
  */
  ...
  Pipelet.build( 'filter', Filter, {
    ...
    add: function( objects, options ) {
      ...
      return this.emit_operations( this.transform( objects ), u, u, options );
    }, // add()
    
    remove: function( objects, options ) {
      var u;
      
      return this.emit_operations( u, this.transform( objects ), u, options );
    }, // remove()
      ...
      switch( typeof filter ) {
        ...
        case 'function':
          this.update = function( updates ) {
            ...
            return this.emit_operations( added, removed, updated, options );
          };
