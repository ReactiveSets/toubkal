  ...
  Pipelet.Build( 'filter_query', Filter_Query, {
    ...
    _update_filter: function() {
      var p = this._filter
        ...
        , source = p._source // ToDo: encapsulation issue, should be defined in Pipelet
      ;
      ...
      if ( source ) {
        ...
        source._query_tree_update( adds, removes, p );
        
        if ( ! p.lazy ) {
          // ToDo: update downstrem pipelets contents
          var added = [], removed = [];
          
          // ToDo: optimization: fetch should specify a query
