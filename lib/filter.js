  ...
  */
  ...
  Pipelet.Build( 'filter_query', Filter_Query, {
    add: function( or_terms, options ) {
      ...
      return options && options.more ? this : this._update_filter( q, filter );
    }, // add()
    ...
    _update_filter: function( q, filter ) {
      ...
      if ( ! filter._lazy ) {
        de&&ug( 'Filter_Query.._update_filter(), adds: ' + log.s( q.adds ) + ', removes: ' + log.s( q.removes ) );
        
        // ToDo: update upstream pipelet's query tree
      }
