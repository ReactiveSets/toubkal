  ...
  */
  ...
  Root.subclass( Output_Transaction, {
    ...
    add_destination: function( input_transactions, forks ) {
      ...
      var s = input_transactions.add( id, this.source, forks ); // ToDo: use this instead of this.source
      ...
      if ( s ) {
        ...
        */
        ...
        de&&ug( this._get_name( 'add_destination_to_transaction' )
          + 'input added to transaction ' + this.tid
  ...
  Root.subclass( Output_Transactions, {
    ...
    */
    get_concurrent_options: function( input, o ) {
      if ( ! input.transactions.tag ) return o; // There are no concurrent transaction at the target input
      ...
      if ( tid ) {
        ...
        if ( ! t.more ) {
          ...
          var s = transaction.remove_destination( tid, input );
