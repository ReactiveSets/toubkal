  ...
  Event_Emitter.subclass( Transaction, {
    ...
    get_emit_options: function() {
      var more = this.get_options().more
        ...
        , nothing_pending = ! ( this.added.length || this.removed.length )
      ;
      ...
      if ( this.need_close ) {
        ...
        if ( ! more ) {
          ...
          this.closed = nothing_pending; // this should be the last emit
        }
      } else {
        ...
        if ( more || fork ) {
          ...
          if ( more ) {
            ...
            this.closed = nothing_pending;
          }
        } else {
          // there was nothing emited before, and this is the sole emit for this transaction
          this.closed = nothing_pending; // this should be the only emit
