...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     [
       ...
       { id: 2, name: 'images/02.jpg', tumbnail: 'images/tumbnails/02-tumbnail.jpg' },
       { id: 3, name: 'images/03.jpg', tumbnail: 'images/tumbnails/03-tumbnail.jpg' },
       { id: 4, name: 'images/04.jpg', tumbnail: 'images/tumbnails/04-tumbnail.jpg' },
       { id: 5, name: 'images/05.jpg', tumbnail: 'images/tumbnails/05-tumbnail.jpg' }
     ]
  ...
  */
  function Gallery( dom_node, options ) {
    ...
    return this.set_gallery_node( dom_node );
  } // Gallery()
  ...
  */
  Load_Images.build( 'gallery', Gallery, {
    set_gallery_node: function( dom_node ) {
