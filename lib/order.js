  ...
  */
  ...
  Set.build( 'order', Order, {
    ...
    wait_for_sorter: function( handler ) {
      this.sorter_waiters.push( handler ); // ToDo: need a test to verify
    ...
    sort: function( sorter ) {
      ...
      if ( ! a ) return this; // a is not yet initialized, nothing to do
    ...
    add: function( objects ) {
      ...
      if ( ! sorter ) return this.wait_for_sorter( function() { that.add( objects ) } );
