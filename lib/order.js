...
( function( exports ) {
  ...
  */
  function Order_Organizer( organizer, order, options ) {
    ...
    return this.add_source( this.organizer = organizer );
  } // Order_Organizer()
  ...
  p.add = p.remove = p.update = function( objects, options ) {
    if ( false && options && options.more ) { // This code is not used, can be removed by minifier
  ...
  Set.build( 'order', Order, {
    ...
    locate: function( objects, options ) {
      ...
      for ( var i = -1; ++i < n; guess += step ) {
        ...
        if ( i === 0 ) {
          locate( this.a, this.organizer, locations, 0, 1, exact, all );
      ...
      return locate( this.a, this.organizer, locations, 1, n, exact, all );
      
      function locate( a, organizer, locations, begin, end, exact, all ) {
          ...
          for ( var i = begin - 1; ++i < end; ) {
            ...
            if ( ( location.order = organizer( a[ guess ], o ) ) === 0 ) {
              ...
              if ( all ) {
                ...
                while ( --first >= start && 0 === organizer( a[ first ], o ) );
                while ( ++last  <  stop  && 0 === organizer( a[ last  ], o ) );
              ...
              if ( insert_before ) {
                ...
                if ( exact && location.found === u ) {
                  ...
                  while ( ++guess < stop && 0 === organizer( a[ guess ], o ) ) {
                ...
                if ( exact && location.found === u ) {
                  ...
                  // look the other way from first match to find an exact match
                  while ( guess && 0 === organizer( a[ guess - 1 ], o ) ) {
                    guess -= 1;
