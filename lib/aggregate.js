...
( function( exports ) {
  ...
  */
  function Aggregate_Dimensions( aggregator, dimensions, options ) {
  ...
  Pipelet.subclass( Aggregate_Dimensions, {
    fetch: function( receiver ) {
      ...
      this.dimensions.length && reveiver( this.dimensions );
    ...
    make_group: function( dimensions ) {
      ...
      this.fetch_all( function( dimensions ) {
        if ( dimensions.length === 0 ) throw new Error( 'Aggregate_Dimensions.make_group(), needs at least one dimension' );
        ...
        var code = new Code( 'group' )
          ._function( 'that.aggregator.group', null, [ 'objects' ] )
  ...
  /* -------------------------------------------------------------------------------------------
     Aggregate_Measures()
  */
  function Aggregate_Measures( aggregator, measures, options ) {
    Pipelet.call( this, options );
  ...
  Pipelet.subclass( Aggregate_Measures, {
    fetch: function( receiver ) {
      ...
      this.measures.length && receiver( this.measures );
    ...
    build_reduce_groups: function() {
      var that = this;
      
      this.fetch_all( function( measures ) {
        that.aggregator.dimensions.fetch_all( function( dimensions ) {
          ...
          var code = new Code()
            ._function( 'that.aggregator.reduce_groups', null, [ 'groups' ] )
  ...
  */
  Pipelet.prototype.aggregate = function( measures, dimensions, options ) {
    return new Aggregate( measures, dimensions, options ).set_source( this );
  ...
  subclass( Set, Aggregate );
  
  extend( Aggregate.prototype, {
    /* -------------------------------------------------------------------------------------------
       aggregate( values )
    ...
    */
    merge: function( aggregates ) {
      ...
      that.measures.fetch_all( function( measures ) {
        var a        = that.aggregates
          , groups   = a.groups
          , keys0    = a.keys
          , h0       = a.hash
        ...
        added  .length && that.emit_add   ( added   );
        removed.length && that.emit_remove( removed );
        updates.length && that.emit_update( updates );
      } );
