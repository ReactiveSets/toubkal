...
( function( exports ) {
  ...
  */
  function Aggregate_Dimensions( aggregate, dimensions, options ) {
    ...
    return this._add_source( this.dimensions = dimensions );
  } // Aggregate_Dimensions()
  ...
  Pipelet.subclass( Aggregate_Dimensions, {
    _fetch: function( receiver ) {
      ...
      if ( dimensions._fetch ) return dimensions._fetch( receiver );
  ...
  p._add = p._remove = p._update = function( _, options ) {
    ...
    return this._fetch_all( function( dimensions ) {
  ...
  */
  function Aggregate_Measures( aggregate, measures, options ) {
    ...
    return this._add_source( this.measures = measures || [] );
  } // Aggregate_Measures()
  ...
  Pipelet.subclass( Aggregate_Measures, {
    _fetch: function( receiver ) {
      ...
      if ( measures._fetch ) return measures._fetch( receiver );
  ...
  p._add = p._remove = p._update = function( _, options ) {
    ...
    return this._fetch_all( fetch_aggregates );
    
    function fetch_aggregates( measures ) {
      that.aggregate.dimensions._fetch_all( function( dimensions ) {
  ...
  */
  ...
  Set.Build( 'aggregate', Aggregate, {
    dimensions_changed: function( dimensions ) {
      ...
      if ( measures ) {
        measures._fetch_all( function( measures ) {
    ...
    rebuild_aggregates: function() {
      ...
      this.__fetch_source( function( values ) {
    ...
    */
    _remove: function( values, options ) {
      ...
      this.measures._fetch_all( function( measures ) {
