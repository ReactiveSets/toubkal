  ...
  */
  function Trace_Domain( realm, emit, query ) {
    ...
    function trace() {
        ...
        switch( ++_gathered ) {
          ...
          case 3: // method
            ...
            if ( instance_levels === ___ ) {
              instance_levels = _methods_instance_levels[ Trace_Domain.any_method ];
            ...
            switch( typeof value ) {
              case 'object':
                if ( value instanceof Array ) {
                  ...
                  for ( var p in value ) _trace[ p ] = value[ p ];
                }
              break;
      ...
      function no_trace_for_instance( instance_levels, instance_name ) {
        ...
        if ( typeof level != 'number' ) {
          level = instance_levels[ Trace_Domain.any_instance ];
    ...
    function query_default() {
      ...
      _instance_levels
        [ Trace_Domain.any_instance ]
        = _trace_level
      ;
      
      _methods_instance_levels
        [ Trace_Domain.any_method ]
        = {}
      ;
    ...
    function query_add( query ) {
      ...
      query
        .forEach( function( term ) {
          ...
          var level = term.level || Trace_Domain.default_trace_level;
          
          level > trace_level && trace_level = level;
          
          var name = term.name || Trace_Domain.any_instance;
          
          _instance_levels[ name ] = level;
          
          var method = term.method || Trace_Domain.any_method;
  ...
  Trace_Domain.any_instance        = 'Any Instance';
  Trace_Domain.any_method          = 'Any Method';
  Trace_Domain.default_trace_level = 5;
  
  var trace = Trace_Domain( 'my test trace domain', function( trace ) {
  ...
  trace >= 3 
    && trace( 3 )
    && ( log( 'trace_1' ) || true )
    && trace( { _get_name: function() { return 'an instance' } } )
    && ( log( 'trace_2' ) || true )
    && trace( 'a_method' )
    && ( log( 'trace_3' ) || true )
    && trace( { a: 1, b: 2 }, 'a message', 3, [ 1, 2, 3 ], function( trace, position ) {
