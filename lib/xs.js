...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     extend_2() is an optimized version of extend() that requires two and only two non-null
     objects parameters.
     ...
     Parameters:
       ...
       source: object(s) which own properties are copied into destination.
         ...
         With extend_2(): One and only one source non-null object is required or an exception
         will be thrown.
  ...
  */
  var x = {}, not_owned_properties = 0, extend, extend_2;
  
  for ( var p in x ) not_owned_properties += 1;
  
  if ( not_owned_properties ) {
    de&&ug( 'Someone has added ' + not_owned_properties + ' enumerable properties in Object.prototype' );
