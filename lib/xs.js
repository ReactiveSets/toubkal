...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     - f (Function): Derived class
     - methods:
       - (Object): methods for f prototype
       - (Function): Function that returns methods Object as above, signature:
         methods( base.prototype )
  */
  function subclass( base, f, methods ) {
    var base_prototype = base.prototype
      , prototype = f.prototype = Object.create( base_prototype )
    ;
    ...
    return prototype.constructor = f;
  } // subclass()
