...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     Order_Organizer()
  */
  function Order_Organizer( organizer, ordered_set, options ) {
  ...
  */
  function Order( organizer, options ) {
    ...
    this.ordered_set_organizer = new Order_Organizer( organizer, this, options );
  ...
  extend( Order, {
    insert_at: function( inserted, options, insert ) {
      ...
      for ( var i = inserted.length; i; ) {
        insert( inserted[ --i ], locations ? locations[ i ] : 0 );
      }
    }, // insert_at()
  ...
  */
  // Deprecated aliases
  var Ordered_Set = Order;
  var Ordered_Set_Organizer = Order_Organizer;
  
  eval( XS.export_code( 'XS', [ 'Order', 'Order_Organizer', 'Ordered_Set', 'Ordered_Set_Organizer' ] ) );
