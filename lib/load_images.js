...
( function( exports ) {
  ...
  */
  ...
  var Set_proto        = Set.prototype
    ...
    , Set_no_value     = Set_proto._no_value
  ;
  ...
  */
  Set.build( 'load_images', Load_Images, {
    ...
    _add_value: function( operation, value ) {
    ...
    _load_image: function( operation, value ) {
      ...
      function onerror() {
        ...
        Set_no_value.call( that, operation );
      ...
      function onload( e ) {
        ...
        Set_add_value.call( that, operation, value );
        
        previous_onload || that._load_next_image();
      }
    }, // _load_image()
    
    _remove_value: function( operation, value ) {
      ...
      if ( image ) {
        ...
        if ( loaded ) {
          Set_remove_value.call( this, operation, value );
        } else {
          ...
          Set_no_value.call( this, operation );
        }
        ...
        // If it does, the count for the add operation would never reach zero, preventing the completion
        // of the transaction
