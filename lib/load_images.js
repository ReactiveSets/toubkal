...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     Options:
       - node_id: DOM node id of the div where images are loaded, default is 'rs_load_images'
  ...
  */
  Set.Build( 'load_images', Load_Images, {
    _set_node: function() {
      var options = this._options
        , node_id = options.node_id || 'rs_load_images'
      ;
  ...
  /* -------------------------------------------------------------------------------------------
     module exports
  */
  eval( RS.export_code( 'RS', [ 'Load_Images' ] ) );
