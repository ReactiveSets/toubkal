  ...
  Set.build( 'load_images', Load_Images, {
    ...
    _add_value: function( transaction, value ) {
      if ( this._loading_count >= this._loading_max ) {
        de&&ug( '_add_value(): throttle image, transaction: ' + log.s( transaction ) ); 
    ...
    _load_image: function( transaction, value ) {
      ...
      function onerror() {
        ...
        Set_no_value.call( that, transaction );
      ...
      function onload( e ) {
        ...
        Set_add_value.call( that, transaction, value );
    ...
    _remove_value: function( transaction, value ) {
      ...
      if ( image ) {
        ...
        if ( loaded ) {
          Set_remove_value.call( this, transaction, value );
        } else {
          ...
          Set_no_value.call( this, transaction );
        }
