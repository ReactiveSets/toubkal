...
( function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
  */
  function HTTP_Server( end_points, options ) {
  ...
  */
  Set.build( 'http_server', HTTP_Server, {
    add: function( end_points ) {
      ...
      for ( var i = -1; ++i < end_points.length; ) {
        ...
        de&&ug( 'HTTP_Server.add(): http server listening to ' + ip_address + ':' + port );
  ...
  } ); // HTTP_SERVER instance methods
  
  /* --------------------------------------------------------------------------
     module exports
  */
  eval( XS.export_code( 'XS', [ 'HTTP_Server' ] ) );
