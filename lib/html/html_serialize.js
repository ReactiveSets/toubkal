...
!function( exports ) {
  ...
  var rs        = exports.rs || require( 'toubkal/lib/core/pipelet.js' )
    , serialize = require( 'htmlparser2/node_modules/domutils' ).getOuterHTML
    , RS        = rs.RS
    , Pipelet   = RS.Pipelet
  ;
  ...
  */
  ...
  var de = true, ug = RS.log.bind( null, 'html serialize' );
  ...
  */
  ...
  Pipelet.Compose( 'html_serialize', function( source, options ) {
