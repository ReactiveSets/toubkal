...
( function( exports ) {
  var Trace_Domain = typeof require === 'function'
    ? require( './trace_domain.js' )
    : exports.Trace_Domain
  ;
  
  var error = Trace_Domain( 'rs' );
  
  var trace = error.set_trace_level( 6 ); // set to false to remove all trace code after minification
  ...
  */
  ...
  if ( not_owned_properties.length ) {
    ...
    trace && trace( 6, '_', 'extend', 'No added enumerable properties in Object.prototype' );
  ...
  */
  function export_code( namespace, exports ) {
    ...
    trace && trace( 7, '_', 'export_code', export_code );
  ...
  function add_exports( attributes ) {
    ...
    trace && trace( 6, '_', 'add_exports', Object.keys( attributes ) );
  ...
  */
  ...
  trace && trace( 6, '_', 'global', 'module loaded' );
} )( this ); // rs.js
