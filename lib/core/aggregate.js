  ...
  Loggable.subclass( 'Aggregate_Dimensions', Aggregate_Dimensions, {
    ...
    build_group: function( dimensions ) {
      ...
      if ( dimensions.length ) {
        safe_ids = dimensions.map( function( d ) { return safe_string( d.id ) } );
        
        key_code = '"#" + v[ ' + safe_ids.join( ' ] + "#" + v[ ' ) + ' ]';
        ...
        safe_ids = [ safe_string( 'id' ) ]; // see Aggregate_Measures.._build_reduce_groups()
