...
( 'aggregate', [ './pipelet' ], function( rs ) {
  ...
  */
  function Aggregate_Dimensions( aggregate, dimensions, options ) {
    ...
    this._input.add_source( dimensions._output || dimensions );
  } // Aggregate_Dimensions()
  ...
  p._add = p._remove = p._update = function( _, options ) {
    ...
    return this._output.fetch_all( function( dimensions ) {
  ...
  */
  function Aggregate_Measures( aggregate, measures, options ) {
    ...
    this._input.add_source( measures._output || measures );
  } // Aggregate_Measures()
  ...
  p._add = p._remove = p._update = function( _, options ) {
    ...
    return this._output.fetch_all( fetch_aggregates );
    
    function fetch_aggregates( measures ) {
      that.aggregate.dimensions._output.fetch_all( function( dimensions ) {
  ...
  */
  ...
  function rebuild_aggregates() {
    ...
    if ( that.aggregates ) {
      ...
      // ToDo: don't use clear, use remove, possibly with transactional fetch
      that._clear();
    }
  ...
  Set.Build( 'aggregate', Aggregate, {
    ...
    measures_changed: function( measures, dimensions ) {
      return this.build_merge( measures, rebuild_aggregates.bind( this ) );
    }, // measures_changed()
    ...
    */
    _remove: function( values, options ) {
      ...
      this.measures._output.fetch_all( function( measures ) {
