...
( 'transactional', [ './pipelet' ], function( rs ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      ToDo: update_fetched() emit update operations instead of remove plus add
  */
  ...
  rs.Compose( 'update_fetched', function( source, update, options ) {
    ...
    return source
      ...
      .pass_through() // ToDo: transform remove plus add with same identity into transaction into update operation, statelessly
    ;
