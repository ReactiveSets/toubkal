...
( 'transactional', [ './pipelet' ], function( rs ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      - fetch_query:
        - (Function): optional, called to build fetch query,
      ...
      ToDo: allow fetch_query to be an Array of picker expressions
      ToDo: provide 'as' option, to implement fetch_as() more efficiently
  */
  function Fetch( store, fetch_query, options ) {
    var that = this, pick;
    
    if ( typeof fetch_query != 'function' && fetch_query ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      - fetch_query (Function or Object): for @@pipelet:fetch()
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      @pipelet fetch_first( store, fetch_query, attribute, options )
      
      @short Set attribute with first fetched value from store by fetch_query
      
      @parameters:
      - store (Pipelet): to @@pipelet:fetch() from.
      - fetch_query (Function or Object): to fetch store, see pipelet fetch().
      ...
      ToDo: fetch_first() delete attribute from emitted values if no fetched value
      ToDo: fetch_first() emit warning if more than one value is fetched
  */
  .Compose( 'fetch_first', function( source, store, fetch_query, attribute, options ) {
