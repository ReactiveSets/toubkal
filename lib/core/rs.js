...
!function( exports ) {
  ...
  var Console_Logger = exports.console_logger || require( '../util/console_logger.js' )
    , Lazy_Logger    = exports.lazy_logger    || require( '../util/lazy_logger.js'    )
    , extend         = exports.extend         || require( '../util/extend.js'         )
    , extend_2       = extend._2
