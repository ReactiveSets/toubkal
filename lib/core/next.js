    ...
    return rs
      .union( [
        ...
        fetched.map( function( _ ) { return _.new_trigger } )
          .delay( 30 )     // prevent foreign key countraint: ToDo: handle this issue at the database layer
          .last()          // respond to fetch immediately, will emit unwanted updates
          .split_updates() // get adds out of updates
          .adds()          // forgo remove
      ], { tag: fetch_tag } )
