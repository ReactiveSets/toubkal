  ...
  */
  Pipelet.Compose( 'join', function( a, b, on, merge, options ) {
    ...
    var name = options.name
      ...
      , _a = rs.half_join( 0, b, on, merge, output, options_a )
      , _b = rs.half_join( 1, a, on, merge, output, options_b )
        ...
        ._function( 'this.__transform', u, [ 'values', 'options', 'operation' ] )
          ...
          ._if( 'operation == "fetch"' );
            ...
            if ( fetch_non_matching ) {
              transform
              .add( 'locations = order.locate( values, { exact: true } ); l = locations.length' )
          ...
          ._while( '++i < l' )
            ...
            ._if( 'matches' )
              ...
              ._while( '++j < ml' )
                ...
                ._var( 'position = this._full_join_output.index_of( _v )' )
                
                ._if( 'position != -1' )
                  .add( 'this.__emit( ( operation == "add" ? "remove" : "add" ), [ this._full_join_output.a[ position ] ], options )' )
                .end()
              ...
              ;all && transform
            ._else()
              .add( 'v = merge( ' + ( position ? 'u, v' : 'v' ) + ' )' )
              
              ._var( 'position = this._full_join_output.index_of( v )' )
