      ...
      var transform = new Code( 'join..__transform(), position: ' + position + ', all: ' + all )
        ._function( 'this.__transform', u, [ 'values', 'options', 'operation' ] )
          ...
          var variable_v         = 'v = _l.o' + ( renames ? '.__v' : '' )
            , non_matching_merge = 'merge( ' + ( position ?            'u, v' : 'v'               ) + ' )'
          ...
          ._if( 'operation == "fetch"' );
            ...
            if ( fetch_non_matching ) {
              ...
              ._while( '++i < l' )
                ...
                ._if( '_l.position === u' )
                  .add( 'out.push( ' + non_matching_merge + ' )' )
                .end()
              .end();
          ...
          ._var( '_output = this._full_join_output', '_operation = operation == "add" ? "remove" : "add"' )
          ...
          ._while( '++i < l' )
            ...
            ._if( 'matches' )
              ...
              ._while( '++j < ml' )
                ...
                // .add( 'de&&ug( "_output.index_of: ", v )' )
                
                ._var( 'position = _output.index_of( v )' )
                
                ._if( 'position != -1' )
                  ._var( '_v = _output.a[ position ]' )
                  
                  // .add( 'de&&ug( _operation + " at position: " + position + ", value:", _v )' )
                  
                  .add( 'this.__emit( _operation, [ _v ], options )' )
                .end()
