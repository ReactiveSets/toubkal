        ...
        ._function( 'this.__transform', u, [ 'values', 'options', 'operation' ] )
          ...
          ._while( '++i < l' ) // all locations
            ...
            ._if( 'matches' )
              ...
              // try to remove non_matching_merge in output
              .add( 'position = _output.index_of( ' + non_matching_merge + ' )' )
              ...
              ._while( '++j < ml' )
                ._if( 'position == -1' ) // non_matching_merge not found in output
            ...
            ._else()
              // try to remove non_matching_merge in output
              .add( '_v = ' + non_matching_merge )
              
              .add( 'position = _output.index_of( _v )' )
