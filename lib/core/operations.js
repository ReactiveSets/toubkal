  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     - initial_state (Array of values): optional initial values to emit as removes as a guess
       on the state that will be fetched from upstream. Once upstream state is know, revert()
  ...
  */
  function Revert( initial_state, options ) {
    ...
    function fetch( receiver, query ) {
      ...
      if ( not_fetched ) {
        ...
        that._input.fetch_source_all( fetched, query ); // _add will actually remove fetched values
      }
      ...
      function fetched( values ) {
        if ( initial_state ) {
          ...
          that.__emit_operations( values, initial_state );
  ...
  Pipelet.Build( 'revert', Revert, function( Super ) { return {
    ...
    __emit_update: function( updates, options ) {
      ...
      return Super.__emit_update.call( this, updates, options );
    }
  } } ); // revert()
