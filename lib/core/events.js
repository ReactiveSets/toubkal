...
( 'events', [ './pipelet' ], function( rs ) {
  ...
  */
  rs.Compose( 'timestamp', { single: true }, function( source, options ) {
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     of events_metadata()
  */
  rs.Compose( 'events_metadata', { single: true }, function( source, options ) {
  ...
  */
  rs.Compose( 'once', { single: true }, function( source, timeout, options ) {
