...
( 'events', [ './pipelet' ], function( rs ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @description:
        If multiple values are received from upstream source in a single "add" operation, the
        last value is kept, and all other values are discarded.
      ...
      @examples:
        ...
        - Throttle window resize events with requestAnimationFrame(), discarding throttle values:
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @short Emit last received source value before throttle events, without throttle events
