  ...
  */
  ...
  Loggable.subclass( 'IO_Transaction', IO_Transaction, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        @returns
        (Array): non-null and not-undefined values returned by *f()*.
        
        @description
        Uses *f()* to filter and map all peers to  an *Array* of non-null and
        not-undefined values returned by f().
    */
    filter_map: function( f ) {
      ...
      for ( id in peers )
        if ( peer = peers[ id ] )
          if ( ( v = f( peer ) ) != ___ ) // i.e. not ( null or undefined )
            a.push( v )
  ...
  /* --------------------------------------------------------------------------
      ...
      - **transactions_options** (Object):
        ...
        are conccurent at this pipelet. E.g.: set tag ```"tag"``` as
        concurrent:
        ```javascript
          { concurrent: { "tag": true } }
        ```
    ...
    return {
      ...
      */
      add_branches: function( branches ) {
        ...
        if ( that.concurrent ) { // Non-concurrent transactions always have a single upstream branch, do not update, do not terminate
          ...
          //de&&
          ug( name() + 'concurrent branches added:', branches, ', new count:', that.branches, ', terminated_count:', that.terminated_count );
      ...
      */
      ...
      /* ------------------------------------------------------------------------
          ...
          @returns
          - null: *source* was not found or there are no concurrent
            transactions at this input.
          
          - (Object): transaction *Object* (_t):
            - **id** (String): this transaction identifier
            
            - **more** (Boolean): optional, true if more are expected from a
              source.
    ...
    /* ------------------------------------------------------------------------
        ...
        - (Object): transaction object
          ...
          - **more** (Boolean):
            ...
            - false or undefined: transaction is now fully terminated.
    ...
    */
    terminate: function() {
      ...
      return that.filter_map( function( input ) {
        ...
        return _t.more
          ? null // more expected, this input does not terminate. !!! do not use falsy value here, it must be null or undefined for filter_map()
          : { _t: _t, input: input }
        ;
  ...
  */
  ...
  IO_Transactions.subclass( 'Output_Transactions', Output_Transactions, {
    /* ------------------------------------------------------------------------
        ...
        @returns
        - (Object): output options with more possibly added to
          transaction object.
          
        @description
        Get output options for a destination input_transactions instance from
        ...
        This is used when there are concurrent pipelets in the graph that
