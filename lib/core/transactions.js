...
*/
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      @class_method Options.enforce_tag_on_many( count, options, tag, transactions_options )
      ...
      - **tag** (String): added tag if a tag is required and none is
        present in *options*.
  ...
  */
  function enforce_tag_on_many( count, options, tag, transactions_options ) {
    var t                   = options && options._t
      , tid
      , more
      , transaction_options
