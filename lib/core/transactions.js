    ...
    get_terminated_destinations: function() {
      ...
      if ( this.count ) {
        ...
        while ( input_transactions = inputs[ ++i ] ) {
          ...
          var s = input_transactions.remove( tid, this.source ); // ToDo: consider using this instead of this.source
          ...
          throw new Error( get_name( this ) + ', expected to find this source as a source_transaction' );
      ...
      function get_name( that ) {
        return that._get_name( 'get_terminated_destinations' ) + ', tid: ' + tid;
      }
