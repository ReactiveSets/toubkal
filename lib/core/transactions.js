    ...
    */
    move_from_to: function( from, to ) {
      ...
      if ( that.get( from ) ) {
        ...
        //de&&
        ug( get_name( that, 'move_from_to' ) + 'new state:', pretty( that ) );
  ...
  IO_Transactions.subclass( 'Input_Transactions', Input_Transactions, function( Super ) { return {
    ...
    */
    move_from_to: function( from, to, tid ) {
      ...
      //de&&
      ug( get_name( that, 'move_from_to' ) + 'input_transaction:', pretty( input_transaction ) );
    ...
    /* ------------------------------------------------------------------------
        ...
        - **source** (Output_Transactions): transactions for the source
    ...
    */
    move_to: function( to, input, tid ) {
      ...
      if ( from && from.move_to( to.get_transaction( tid ), input, tid ) ) {
        //de&&
        ug( get_name( that, 'move_to' ) + 'moved from, to:', pretty( from ), pretty( to ) );
