...
*/
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      @parameters
      - **container** (@@class:IO_Transactions\): containing this io
      transaction.
  ...
  Loggable.subclass( 'IO_Transaction', IO_Transaction, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        @parameters
        - **io_transactions** (@@class:IO_Transactions or @@class:Input\):
        to add to this.
  ...
  IO_Transactions.subclass( 'Input_Transactions', Input_Transactions, function( Super ) { return {
    ...
    */
    remove: function( tid, source ) {
      ...
      if ( _t ) _t.more || Super.remove.call( this, input_transaction );
