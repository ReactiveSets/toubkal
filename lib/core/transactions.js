...
!function( exports ) {
  ...
  var uuid          = exports.uuid     || require( 'node-uuid' )
    , uuid_v4       = uuid.v4
    , RS            = exports.RS       || require( './rs.js' )
    , Event_Emitter = RS.Event_Emitter || require( '../util/event_emitter.js' )
  ...
  RS.uuid_v4 = uuid.v4; // exports uuid_v4 into RS, ToDo: this should be done in rs.js maybe, or not at all since this is an external module
