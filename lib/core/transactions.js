    ...
    get_emit_options: function() {
      var that    = this
        ...
        , more    = // !! Must be a Boolean
            ...
            || that.count          > 0
            || that.removes.length > 0 // ToDo: add test(s) for Boolean values returned by get_emit_options() and next_options()
