...
*/
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @short Base class for Input_Transactions and Output_Transactions.
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @description
      This is the base for class Input_Transaction() and class Output_Transaction().
  */
    ...
    */
    error: function( method, other, message ) {
      ...
      if( warned ) {
        ...
        message.push(
          '\n    - Full content of this ' + type + ':', that
        );
      }
        ...
        if( that.get( source ) ) {
          ...
          if( that.count ) {
            not_concurrent && error( [
              ...
              '\n' +
              '\n  To fix this issue:' +
              '\n    - If this is due to an untagged diamond graph:' +
              '\n      - Add a fork tag at the start of the diamond,' +
              '\n      - and add the same tag at this input: ' + get_input_name() +
              '\n' +
              '\n    - If this is due to not concurrent but tagged diamond graph:' +
  ...
  IO_Transaction.subclass( 'Output_Transaction', Output_Transaction, {
    ...
    */
    add_destination: function( input, forks ) {
      ...
      // ToDo: add_destination(): multiple inputs can share the same input_transactions object, although this is unlikely to happen in practice, use input instead of input_transactions
  ...
  IO_Transactions.subclass( 'Output_Transactions', Output_Transactions, {
    /* ------------------------------------------------------------------------
        ...
        - options (Object): optional, output options before taking into
          account destination inputs and possible graph diamonds
        ...
        ToDo: rename calculate_sender_options()
    ...
    */
    get_options: function( input, options ) {
      ...
      if ( options && ( _t = options._t ) && ( tid = _t.id ) ) {
        ...
        if ( _t.more || forks ) {
          de&&ug( _get_name() + ', add destination' );
      ...
      function _get_name() {
        return get_name( that, 'get_options' );
      }
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        @short Remove input from output_transaction
    ...
    */
    remove_destination: function( output_transaction, input ) {
      ...
      if ( output_transaction ) {
        de&&ug( get_name( that, 'remove_destination' ) );
