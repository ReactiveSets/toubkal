  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      require( 'toubkal' )
        ...
        .trace( 'tranasctions', { fetched: false } ).greedy()
      ;
      ```
      ...
      2018/11/23 14:22:34.919 - Trace( tranasctions )..add(),  {
        "values": [
          {
            "adds": [
              {
      ...
      */
      ...
      that._emit_transactions
        ?
          ...
          that.__emit( 'add', [ { adds: adds, removes: removes, updates: updates } ], options )
