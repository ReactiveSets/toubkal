...
( 'RS', [ 'console_logger', 'lazy_logger', 'extend', 'subclass', 'code', 'event_emitter', 'value_equals' ].map( function( d ) { return '../util/' + d } ),
function(  Console_Logger,   Lazy_Logger,   extend,   subclass,   Code,   Event_Emitter,   value_equals ) {
  'use strict';
  
  var RS       = {
        'add_exports'   : add_exports,
        'uuid'          : this.uuid || require( 'node-uuid' ),
        'extend'        : extend,
        'subclass'      : subclass,
        'Code'          : Code,
