...
( 'RS', [ 'console_logger', 'lazy_logger', 'extend', 'subclass', 'code', 'event_emitter' ].map( function( d ) { return '../util/' + d } ),
function(  Console_Logger,   Lazy_Logger,   extend,   subclass,   Code,   Event_Emitter ) {
  'use strict';
