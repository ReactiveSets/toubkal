...
( 'RS', [ 'console_logger', 'lazy_logger', 'extend', 'subclass', 'loggable', 'code', 'event_emitter', 'value_equals', 'object_diff', 'timestamp_string', 'picker' ].map( function( d ) { return '../util/' + d } ).concat(
[ [ 'uuid', 'node-uuid' ] ] ),
function(  Console_Logger,   Lazy_Logger,   extend,   subclass,   Loggable,   Code,   Event_Emitter,   value_equals,   object_diff,   timestamp_string,   picker, uuid ) {
  'use strict';
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      If object is defined and object has a _get_name() method, such as
      @@class:Loggable, call this _get_name() method on object with method
      as a parameter.
  ...
  */
  ...
  /* --------------------------------------------------------------------------
     ...
     Deprecated: mutate the RS Object directly
