...
( 'RS', [ 'console_logger', 'lazy_logger', 'extend', 'subclass', 'loggable', 'code', 'event_emitter', 'value_equals' ].map( function( d ) { return '../util/' + d } ).concat(
[ [ 'uuid', 'node-uuid'] ] ),
function(  Console_Logger,   Lazy_Logger,   extend,   subclass,   Loggable,   Code,   Event_Emitter,   value_equals, uuid ) {
  'use strict';
