...
( 'validate', [ './pipelet' ], function( rs ) {
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @description:
        ...
        If there are no errors, emit incomming values, emit nothing if there are errors.
      ...
      @emits errors, in incomming adds, if any attribute value does not validate, attributes:
        - flow       (String): "error"
