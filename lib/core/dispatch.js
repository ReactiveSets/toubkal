  ...
  */
  ...
  Greedy.subclass( 'Dispatch', Dispatch, {
    _add: function( new_branches, options ) {
      ...
      options = enforce_tag_on_many( count, options, that._branches_tag, that._transactions );
    ...
    _remove: function( removed_branches, options ) {
      ...
      options = enforce_tag_on_many( removed_branches.length, options, that._branches_tag, that._transactions );
