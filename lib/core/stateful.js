    ...
    _add: function( values, options ) {
      ...
      if ( new_key ) {
        /*
          ...
          - Propagation of option new_key is dangerous, will affect
          ...
          A possibility is to implement set_key() in Output to all destinations, Input to Pipelet,
          Pipelet, and Controllet.
        ...
        */
        ...
        // ToDo: do not set key if key was set by programmer (i.e. not set from upstream key)
