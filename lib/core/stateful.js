  ...
  */
  .Compose( 'database_cache', function( source, schema, options ) {
    ...
    rs
      ...
      // ToDo: database_cache(): consider transactions on query_updates() plus optimize after pick() instead of adds() here
      // This would allow to unload a no-longer used cache.
      .adds()
