...
( 'stateful', [ './filter' ], function( rs ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      @description
      Discards added values that have the same @@identity\. This implies
      that the set has a proper @@key set. When the key is not properly set,
      a possible symptom is that values' identities are undefined, and only
      one value will be added in the unique set.
