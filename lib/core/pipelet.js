  ...
  Union.Output = Controllet_Output.subclass(
    ...
    /* ------------------------------------------------------------------------
        ...
        *receiver* is called with the additional *terminated_source*
        ...
        This fetch cannot be canceled directly. Cancellation is done by each
        soource using @@method:Ouput..cancel_fetches() when individual
        @@inputs are removed using @@method:Input..remove_source(). If all
        sources of a @@pipelet:union() cancel fetches, this fetch will
        effectively cancel.
