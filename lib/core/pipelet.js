  ...
  */
  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        @method Plug..update_upstream_query( changes, destination, transformed, upstream_changes )
        ...
        changes returned by @@method:Plug.._update_query(), which may be
    ...
    update_upstream_query: function( changes, destination, transformed, upstream_changes ) {
      ...
      if ( transformed
        ...
        if ( synchronous && ( query_updates = that.query_updates ).length ) {
          ...
          // ToDo: shouldn't done be set to truly if _apply_upstream is undefined?
