    ...
    */
    _update_subscription: function( input, changes, options, then ) {
      ...
      if ( rl * fetch ) {
        ...
        source._transactional_fetch( input, transaction, count, removes, null, options, true, _then );
      }
      ...
      al * fetch
        ...
        && source._transactional_fetch( input, transaction, 1, adds, null, options, false, _then )
      ;
