...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    /* ------------------------------------------------------------------------
       ...
       Get a name string for this Plug pipelet instance typically as a helper
       for debug traces.
       
       Parameters:
       - method_name (String): optional, passed to this.pipelet._get_name() to
  ...
  */
  function Input( p, name ) {
    ...
    this.transactions = new Input_Transactions( this );
  } // Input()
  ...
  Plug.subclass( 'Input', Input, {
    ...
    */
    _transactions_remove_source: function( output ) {
      var terminated_transactions_objects = this.transactions.remove_source( output.transactions )
        , i = -1, t
      ;
  ...
  */
  function Output( pipelet, name ) {
    ...
    // Output transactions
    this.transactions = new Output_Transactions();
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    ...
    _route: function( operation, values, options ) {
      ...
      ;
      // ToDo: all transaction code need to move to transactions.js through a single method call e.g. this.transactions.set_options( o, this.destinations, subscribers_operations )
      // ToDo: this method could return an updated list of subscribers to notify
      ...
      */
      ...
      if ( _t && ! _t.more ) {
        ...
        transactions
          .get_terminated_input_transactions( o )
          
          .forEach( function( input_transaction ) {
            input_transaction.input.add( [], o )
          } )
        ;
      }
