  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        The ```"query_changes"``` parameter should not be defined if not
        processed, allowing an optmization.
    */
    ...
    */
    _fetch: function( receiver, query, query_changes, destination, __query_changes ) {
      ...
      if ( _query && ! _query.length ) {
        ...
        _query_changes
          && changes_count( _query_changes )
          && that.update_upstream_query( _query_changes, destination )
        ;
