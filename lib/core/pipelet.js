...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  function get_name( o, method ) {
    return o._get_name ? o._get_name( method ) : toString.call( o );
  } // get_name()
  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    update_upstream_query: function( changes, destination ) {
      ...
      de&&ug( get_name( that, 'update_upstream_query' ) + 'changes:', changes, '\n  source:', source && get_name( source ) );
    ...
    */
    _update_query: function( changes ) {
      ...
      if ( rl + al ) {
        ...
        // log( get_name( that, '_update_query' ) + 'changes:', changes, ', query:', q.query, ', optimized:', q.optimized );
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    _update_subscription: function( input, changes, options, then ) {
      ...
      // log( get_name( source, '_update_subscription' ) + 'changes:', changes, ', sync:', sync, 'count:', count );
