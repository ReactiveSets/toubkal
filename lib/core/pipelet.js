  ...
  Loggable.subclass( 'Pipelet', Pipelet, {
    ...
    */
    remove_source_with: function( source, output ) {
      ...
      ( source._input || source ).once( 'renove_source', remove_source );
    ...
    /* ------------------------------------------------------------------------
        ...
        @short Disconnect first @@destination when ```source``` disconnects
    ...
    */
    remove_destination_with: function( source, input ) {
      ...
      function remove_source( _, options ) {
        input = input ? input._input || input : output.destinations[ 0 ];
        
        input && input.remove_source( output, options );
      } // remove_source()
