    ...
    */
    _fetch: function( receiver, query, query_changes, destination, __query_changes ) {
      ...
      function fetch_abort() {
        ...
        else if ( _query_changes )
          if ( fetch_unfiltered )
            fetch_unfiltered.length > 1 &&
              fetch_unfiltered.call( that, ___, swap_query_changes( _query_changes ) )
          
          else if ( update_upstream_query = source && source.update_upstream_query )
            update_upstream_query.call( source, swap_query_changes( _query_changes ) )
      } // fetch_abort()
