  ...
  Loggable.subclass( 'Pipelet', Pipelet, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        - f (Function): transaction processor, signature:
            f( transaction, count ):
            - this (@@class:Pipelet): context for this pipelet
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        - use the @@pipelet:optimize() pipelet downstream of this pipelet
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        @short Compose a singleton pipelet from one or more pipelets in order to provide a reusable
        component.
        
        @description:
        See @@method:Pipelet..Compose() for behavior with options "union" and "singleton" set to true.
    */
