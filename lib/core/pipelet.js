        ...
        */
        if ( terminated_inputs ) {
          ...
          var subscribers = that
            ...
            .get_all_subscribers() // ToDo: Query_Tree..get_all_subscribers(): provide optional filter function, rename get_subscribers()
          ...
          // ToDo: provide Query_Tree..subscribers_operation( operation, filter ) -> subscribers_operation
