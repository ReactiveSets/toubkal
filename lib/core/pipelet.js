...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
      ...
      @parameters:
        ...
        - options: (Object) For maximum performances, e.g. for very large dispachers with
          ...
          - loop: (Boolean) true if the dispatcher is has the gatherer union for input, so
              ...
              dispatch all application events, handling both internal and extenal events, the
  ...
  */
  ...
  Set.Build( 'unique', Unique_Set, function( Super ) { return {
    _add: function( values, options ) {
      var that       = this
        , l          = values.length
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      @description:
        ...
        performances significantly, especially betwwen clients and servers but also in
