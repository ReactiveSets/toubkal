  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    _fetch: function( receiver, query, query_changes, destination, __query_changes ) {
      ...
      // ToDo: [feature] return abort_this_fetch
      // ToDo: [feature] implement abort for this fetch, should cancel query changes if any and abort upstream
      ...
      function cancel() {
        ...
        output_listeners && remove_output_listeners();
      ...
      function rx( values, no_more, operation, options, terminated_source ) {
        ...
        function add_output_listener() {
          ...
          function added_receiver( operation, values ) {
            //de&&
            ug( get_name( that, 'added_listener' ) + 'emit operation:', operation + ', values:', values.length );
      ...
      function remove_output_listeners() {
        var i              = -1
          , j
          , listener
          , listeners
