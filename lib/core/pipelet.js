  ...
  */
  ...
  Plug.subclass( 'Input', Input, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        @method Input..fetch( receiver, query )
        
        ToDo: implement Input..fetch(), replaces _fetch_source()
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    _fetch: function( receiver, query ) {
      ...
      //   it should be transformed by a query_tranform function that does the opposite as the transform
      ...
      // ToDo: emit to a receipient object (default to this.pipelet._input) implementing fetch()
    ...
    */
    _update_subscription: function( input, changes, options, then ) {
      ...
      count && source.query_update( removes, adds, input );
  ...
  Greedy.subclass( 'Dispatch', Dispatch, {
    ...
    _remove: function( removed_branches, options ) {
      ...
      while ( branch = removed_branches[ ++i ] ) {
        ...
        // ToDo: unplug output after input has fully unsibscribed (after fetching and updating)
        // ToDo: allow to fetch on removal, on input, output or both
        // ToDo: allow transaction to control branch addition and removal, possibly tagged
        ...
        // Unplug using no_fetch because there is nowhere to send removes to (disconnected socket.io client)
        ( input = branch.input )
