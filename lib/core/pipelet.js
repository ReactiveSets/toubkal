  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        if defined then  method Input.._update_query() or
  ...
  Plug.subclass( 'Input', Input, function( Super ) { return {
    ...
    */
    _fetch: function( receiver, query, query_changes, destination ) {
      ...
      if ( _update_query ) {
        // Find-out query_changes differences on future query query
        
        _query_changes = _update_query.call( that, query_changes, destination, 'future_query' );
      ...
      try {
        ...
        if( typeof stack == 'string' ) {
          ...
          while(
            ...
            &&
              (
                  frame.indexOf( 'lib/core/pipelet.js' ) > 0
                ||
