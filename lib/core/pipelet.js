...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  var Code                   = RS.Code
    ...
    , operations             = RS.operations = [ 'add', 'remove', 'update', 'clear' ]
  ...
  */
  ...
  Plug.subclass( 'Input', Input, function( Super ) { return {
    ...
    */
    ...
    // clear() does not handle _output_listeners
    // ToDo: remove deprecared clear()
    clear: function( options ) {
      this.pipelet._clear( options );
    }, // Input..clear()
    
    // ToDo: remove deprecated, never used Input..notify()
    // notify does not handle _output_listeners
