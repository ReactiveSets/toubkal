  ...
  Plug.subclass( 'Input', Input, {
    ...
    remove_source: function( source, options ) {
      ...
      if ( source._is_a && source._is_a( 'Output' ) ) {
        ...
        this
          ...
          // ToDo: the following should be assynchronous, after _remove_source_subscription() completes
    ...
    */
    _update_source_array: function( source, options ) {
      ...
      if ( ! ( options && options.no_fetch ) ) { // Don't add or remove anything
        ...
        that[ ( options && options.operation ) || 'add' ]( source, options_forward( options ) );
      }
    ...
    */
    _add_source_subscription: function( source, options ) {
      ...
      that._update_subscription( [ [], q && q.query ], that._fetch_option( options ), source );
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        @method Input.._update_subscription( changes, options, source )
  ...
  */
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        @method Output.._update_subscription( input, changes, options )
        ...
        - options (Object):
          ...
          - _t (Object): upstream transaction requesting subscription changes
    */
    _update_subscription: function( input, changes, options ) {
      var source  = this
        , fetch   = ! ( options && options.no_fetch )
        , removes = changes[ 0 ]
        , adds    = changes[ 1 ]
        , rl      = removes && removes.length
        , al      = adds    && adds   .length
