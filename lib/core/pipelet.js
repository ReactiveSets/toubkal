    ...
    */
    _transactional_fetch: function( destination, query, options, next ) {
      ...
      /*
        ...
        - Upstream query updates will be done at the same time of the fetch request
        - Local query updates will be delayed until fetch receives values
        ...
        - Assuming that fetch and other operations travel without changes in order, this will
          ...
          So when a (transactional) fetch arrives at a pipelet the solution will be to also delay
          sending fetch responses until all transactions are complete.
