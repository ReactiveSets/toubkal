...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    _update_subscription: function( input, changes, options, then ) {
      ...
      if ( rl * fetch ) {
        ...
        source._transactional_fetch( input, transaction, count, removes, options, true, _then );
      }
      ...
      al * fetch
        ...
        && source._transactional_fetch( input, transaction, 1, adds, options, false, _then )
      ;
    ...
    */
    _transactional_fetch: function( destination, transaction, count, query, options, revert, next ) {
      var that  = this
      ...
      */
      that._fetch( rx, query, null, destination );
