...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     ...
     Possible use case:
     - An asynchronous stateless pipelet, whereas alter() is synchronous in
     ...
     - Managing transactions for developer
  ...
  * /
  function Stateless( name, transform ) {
    ...
    de&&ug( 'alter(), transform: ' + transform + ', options: ' + log.s( options ) );
  ...
  */
  function Alter( transform, options ) {
    ...
    this._input = this._input || new Alter.Input( this, options.name, options.query_transform );
  ...
  function Alter_Input( p, name, query_transform ) {
    ...
    if ( typeof query_transform == 'function' ) {
    ...
    function ( Super ) {
      return {
        fetch_source: function( receiver, query ) {
          ...
          return Super.fetch_source.call( this, rx, query );
