...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      Important requirement: The upstream source must provide a unique @@key which is used to
      store an association of identities to assigned auto-incremented values.
