...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  function Input( p, name, tag, input_transactions ) {
    ...
    that.transactions = input_transactions || new Input_Transactions( name, that );
  ...
  */
  function Greedy( options ) {
    ...
    that._input = that._input || new Greedy.Input( that, options.name, options.tag );
  ...
  function Greedy_Input( p, name, tag, input_transactions ) {
    var that = this;
