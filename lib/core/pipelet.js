  ...
  */
  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    ...
    // Virtual Plug.._fetch( receiver, query )
  ...
  Plug.subclass( 'Input', Input, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        ToDo: implement Input..fetch(), replaces _fetch()
        
        API in progress: this method is meant to eventually replace
        _fetch(), providing additional services that could not be
        implemented with _fetch() API. The new API should allow:
    ...
    */
    _fetch: function( receiver, query ) {
      ...
      de&&ug( name = this._get_name( "_fetch" ), 'query:', query );
