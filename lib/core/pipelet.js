    ...
    */
    ...
    _route: function( operation, values, options ) {
      ...
      */
      ...
      if ( _t && ! _t.more ) {
        // ToDo: if there are fork tags, make sure all downstream pipelets have been notified of the end of the transaction
        
        // This transaction is terminated here, notify inputs which had this transaction started
        transactions
