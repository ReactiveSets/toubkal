    ...
    */
    update_upstream_query: function( changes, destination ) {
      ...
      if ( ! query_transform
        ...
        if ( _update_query = that._update_query ) {
          query_updates = that.query_updates;
          
          if ( query_updates && query_updates.length )
            ...
            _update_query.call( that, changes, destination )
          ;
        }
        ...
        apply_upstream( changes );
      }
      
      // ToDo: inline apply_upstream()
    ...
    */
    _fetch: function( receiver, query, query_changes, destination, __query_changes ) {
      ...
      if ( query_transform ) {
        ...
        if ( _update_query ) { // this plug applies query updates locally
  ...
  Plug.subclass( 'Output', Output, {
    ...
    */
    ...
    /* ------------------------------------------------------------------------
        ...
        query updqtes resulting from cancellation.
    */
    ...
    */
    _transactional_fetch: function( destination, transaction, count, query, query_changes, options, revert, next ) {
      ...
      function receiver( values, no_more, operation, _options ) { // ToDo: use _options
        ...
        if ( l ) {
          destination[ [ 'add', 'remove', 'update' ][ operation || 0 ] ]( values, get_options( more ) );
