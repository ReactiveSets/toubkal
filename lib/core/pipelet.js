...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  Loggable.subclass( 'Pipelet', Pipelet, {
    ...
    */
    create_namespace: function( name ) {
      return new Namespace( assert_scope( this ), name );
    }, // create_namespace()
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      - name (String): @@Loggable name for debugging purposes
      
      @manual internal
  */
  function Namespace( pipelet, name ) {
    var that   = this
  ...
  Pipelet.subclass( 'Namespace', Namespace );
  ...
  */
  var rs = new Namespace( null, 'root' );
