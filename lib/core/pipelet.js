...
( 'pipelet', [ './RS', './query', './transactions' ], function( RS, Query, Transactions ) {
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      @short Emit query updates from pipelet
      
      @parameters
      - from (@@class:Pipelet\): which output receives query updates.
      ...
      Will restore the original @@method:Plug..update_upstream_query()
      when its output is disconnected from all destinations.
