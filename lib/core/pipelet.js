  ...
  Event_Emitter.subclass( 'Plug', Plug, {
    ...
    */
    _fetch: function( receiver, query, query_changes, destination, __query_changes ) {
      ...
      // ToDo: if defined, apply _upstream_query_changes() on _query_changes
      ...
      if ( fetch_unfiltered ) {
        ...
        // Forward upstream subscription changes
        _query_changes && that.update_upstream_query( _query_changes, destination );
    ...
    _apply_done_query_updates: function() {
      ...
      while ( ( query_update = query_updates[ 0 ] ) && ( done = query_update.done ) ) {
        ...
        that._update_query( query_updates.shift().changes, query_update.destination )
