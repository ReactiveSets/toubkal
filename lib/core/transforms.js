  ...
  /* --------------------------------------------------------------------------
      ...
      - query:
        ...
        - (Array of Strings): where each string specifies a flow
          attribute value delivered upstream. The Array is reactive
          when using methods that mutate it such as ```push()``` and
          ```pop()```. The order of flows in the Array is semantically
          non-significant.
