  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      - **options** (optional Object): options for pipelet filter():
        - **key** (Array of Strings): @@key, default is
          ```filter_pick_keys( inverse_expression( expression ) )```
      ...
      *pick()*:
      ...
      source
        .filter(
          ...
          { key: [ "project_id" ], filter_keys: [ "project_id" ] }
        )
      ```
  ...
  */
  rs.Compose( 'filter_pick', function( source, parent, expression, options ) {
    ...
    if ( inverse_expression ) {
      ...
      options = extend( { key: filter_keys, filter_keys: filter_keys }, options )
    }
