...
( 'transforms', [ './group_by' ], function( rs ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      @pipelet filter_pick( parent, flow, attributes, options )
      ...
      @description:
        ...
        ```javascript
          source.filter_pick( parent, flow, { project_id: 'id' } )
        ```
      ...
      @parameters:
        ...
        - options (optional Object): options for map()
  */
  rs.Compose( 'filter_pick', function( source, parent, flow, attributes, options ) {
