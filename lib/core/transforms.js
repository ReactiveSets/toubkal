...
( 'transforms', [ './group_by', '../util/cancelable' ], function( rs, cancelable ) {
  ...
  */
  ...
  function Alter( transform, options ) {
    ...
    if ( transform.length == 4 ) return assynchronous();
    ...
    function assynchronous() {
      ...
      that._add    = assynchronous_operation( 0, emit( '__emit_add'    ) );
      that._remove = assynchronous_operation( 1, emit( '__emit_remove' ) );
      ...
      function assynchronous_operation( operation, done ) {
        return function( values, options ) {
          ...
          function clone_transform( value, next ) {
            return transform( extend_2( value ), operation, next )
          }
        }
