  ...
  Filter.Output = Pipelet.Output.subclass(
    ...
    update_upstream_query: function( removes, adds ) {
      ...
      if ( p._filter ) {
        ...
        _update_upstream_query.call( this, removes, adds );
      ...
      if ( downstream_query.adds.length || downstream_query.removes.length ) {
        ...
        _update_upstream_query.apply( this, p._get_upstream_query_changes() );
    ...
    */
    ...
    _init_filter_query: function( filter ) {
      ...
      function update_query( options ) {
        ...
        if ( ! more && filter_query.adds.length + filter_query.removes.length ) {
          ...
          that._input._update_subscription( changes, options );
        }
      } // update_query()
    }, // _init_filter_query()
