  ...
  */
  ...
  Pipelet.Build( 'filter', Filter, function( Super ) { return {
    ...
    */
    ...
    // ToDo: filter(), implement straight forwarding _add, _remove, _update, with no attempt to filter out values, query tree will dispatch to destinations according to queries, transform would still be used by fetch()
