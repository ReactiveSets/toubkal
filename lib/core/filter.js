      ...
      return {
        ...
        update_upstream_query: function( removes, adds ) {
          ...
          if ( p._filter ) {
            ...
            _update_upstream_query.call( that, removes, adds );
          ...
          changes[ 0 ].length + changes[ 1 ].length
            ...
            // ToDo: Output.._update_upstream_query() implement parameter changes instead of removes + adds
            && _update_upstream_query.apply( that, p._get_upstream_query_changes() )
          ;
    ...
    */
    ...
    _init_filter_query: function( filter ) {
      ...
      function update_query( options ) {
        ...
        changes[ 0 ].length + changes[ 1 ].length
          && that._input._update_subscription( that._get_upstream_query_changes(), options )
        ;
      } // update_query()
    }, // _init_filter_query()
