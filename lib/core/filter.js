    ...
    _fetch: function( receiver, query, query_changes, destination ) {
      ...
      if ( query_changes ) {
        ...
        if ( al + removes.length ) {
          _query_changes = that._upstream_query_changes( query_changes, destination );
          
          if( ! changes_count( _query_changes ) ) _query_changes = ___;
        }
      }
      ...
      Plug_p._fetch.call(
        ...
        _query_changes, // changes to apply upstream immediately
    ...
    */
    _get_upstream_query_changes: function( query_name ) {
      var that             = this
        ...
        ,   upstream_query = that._input[ query_s ] // ToDo: should this use query_name also?
