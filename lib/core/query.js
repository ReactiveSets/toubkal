            ...
            if ( key in eb ) {
              ...
              if ( t0 !== t1 ) {
                ...
                push.apply(
                  ...
                  // ToDo: implement 'reset' operator to do the equivalent of [ '__', key ] and also resetting regexp and groups to null
                  // Using implicit AND after reseting current value using [] ToDo: have operator '&&' behave like []
                  e2[ key ] =
