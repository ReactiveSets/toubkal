...
( 'query', [ './RS' ], function( RS ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
      ...
      The OR operation is provided by Query..add() which adds expressions into
      an existing query. The resulting query is optimized to remove redundant
      expressions. More details in Query..add().
      ...
      of a dataflow to many clients each with a different query filtering what
      it processes.
  ...
  */
  ...
  Loggable.subclass( 'Query.Evaluation_Context', Query.Evaluation_Context, {
    get_regexp: function( r, options ) {
      ...
      return r;
    }, // Query.Evaluation_Context.get_regexp()
