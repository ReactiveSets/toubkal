  ...
  */
  ...
  Loggable.subclass( 'Query.Evaluation_Context', Query.Evaluation_Context, {
    evaluate: function( expression ) {
      ...
      if ( toString.call( expression ) === '[object Array]' ) {
        var skip = false, i = 0;
      ...
      } else { // toString.call( expression ) === '[object Array]'
  ...
  function contains( a, left ) {
    ...
    if ( toString.call( left ) === '[object Array]' ) {
  ...
  Operator( 'year', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCFullYear() : fail;
  } );
  
  Operator( 'month', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCMonth() : fail;
  } );
  
  Operator( 'day', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCDate() : fail;
  } );
  
  Operator( 'hours', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCHours() : fail;
  } );
  
  Operator( 'minutes', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCMinutes() : fail;
  } );
  
  Operator( 'seconds', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCSeconds() : fail;
  } );
  
  Operator( 'milliseconds', function( date ) {
    return toString.call( date ) === '[object Date]' ? date.getUTCMilliseconds() : fail;
  } );
  ...
  Loggable.subclass( 'Query', Query, {
    ...
    */
    add: function( q1 ) {
      ...
      if ( toString.call( q1 ) === '[object Array]' ) {
      ...
      function route( node, value, add_value ) {
        ...
        for( i = -1; key = keys[ ++i ]; ) {
          ...
          if ( child ) {
            ...
            if ( typeof expressions == 'object' && toString.call( expressions ) === '[object Array]' ) {
