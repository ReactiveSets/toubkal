  ...
  Loggable.subclass( 'Query', Query, {
    ...
    */
    add: function( q1 ) {
      ...
      that.history.push( [ 'add', q1.slice(), new Date() ] );
    ...
    */
    remove: function( q1 ) {
      ...
      that.history.push( [ 'remove', q1.slice(), new Date() ] );
  ...
  */
  ...
  Loggable.subclass( 'Query_Tree', Query_Tree, {
    ...
    add: function( or_terms, subscriber ) {
      ...
      that.history.push( [ get_name( subscriber ), 'add', or_terms.slice(), new Date() ] );
    ...
    remove: function( or_terms, subscriber ) {
      ...
      that.history.push( history = [ get_name( subscriber ), 'remove', or_terms.slice(), new Date() ] );
