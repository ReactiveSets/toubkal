  ...
  */
  ...
  Loggable.subclass( 'Query_Tree', Query_Tree, {
    ...
    /* ------------------------------------------------------------------------
        ...
        Returns an Array of all subcribers empty operations, at most once.
        
        Each subscriber is a new Object with one attribute:
        - input (Input): input for this subscriber
        - count (Number): number of times input is referenced in query tree
    */
