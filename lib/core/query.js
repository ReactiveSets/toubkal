  ...
  Loggable.subclass( 'Query', Query, {
    ...
    */
    and: function( q1 ) {
        ...
        while ( e1 = q1[ ++i1 ] ) {
          ...
          while ( key = ka[ ++i ] ) {
            if ( key in eb ) {
              ...
              different = true;
              // ToDo: consider merging incrementally here
            }
          }
      ...
      // ToDo: consider discarding optimized, since and() has no opposite operation, at least for now
