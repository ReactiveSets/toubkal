...
( 'code', [ './extend', './javascript', './escape', './console_logger' ], function( extend, javascript, escape, Console_Logger ) {
  "use strict";
  ...
  */
  ...
  extend( Code.prototype, {
    ...
    begin: function( code ) {
      ...
      that.indent = that.indent.slice( 2 );
  ...
  function safe_string( s ) {
    ...
    return double_quotes + escape_double_quotes( '' + s ) + double_quotes
  }
