...
( function( exports ) {
  ...
  // ToDo: remove dependency on rs.js
  var RS     = exports.RS || require( '../core/rs.js' )
    , extend = RS.extend
    , slice  = Array.prototype.slice // ToDo: consider using demethodize()
  ;
  
  /* -------------------------------------------------------------------------------------------
     de&&ug()
  */
  var de = false, ug = RS.log.bind( null, 'code' );
