...
function( Console_Logger,     subclass,     extend ) {
  ...
  */
  ...
  subclass( null, Loggable, function( Super ) {
    var options = {};
    ...
    return {
      ...
      */
      _get_options: function _get_options( _options ) { return options },
      ...
      /* ------------------------------------------------------------------------
         ...
         Sets instance options properties. Modifies only provided attributes
      */
      _get_name: function _get_name( f_name ) {
        var name = f_name ? '..' + f_name + '()' : '';
  ...
  var Loggable_Class_Attributes = {
    ...
    classes_names: function() {
      return this.classes()
        .map( function( _class ) { return _class.class_name } )
      ;
    }, // Loggable.classes_names()
    ...
    subclass: function( class_name, derived, methods ) {
      ...
      debug && log( 'Class ' + class_name + ', subclassed from ', this.classes_names() );
