...
( function( exports ) {
  ...
  */
  function Socket_IO_Crossover( socket, options ) {
    ...
    this.socket = socket
      ...
      .on( 'xs_fetched_values', function( data ) {
        ...
        var id = data.id
          , receiver = Socket_IO_Crossover.fetch_receivers[ id ]
        ;
        
        if ( receiver ) {
          var no_more = data.no_more;
          
          if ( no_more ) delete Socket_IO_Crossover.fetch_receivers[ id ];
  ...
  Socket_IO_Crossover.fetch_id = 0;
  Socket_IO_Crossover.fetch_receivers = {};
  ...
  Pipelet.subclass( Socket_IO_Crossover, {
    ...
    fetch: function( receiver, options ) {
      var id = ++Socket_IO_Crossover.fetch_id;
      
      Socket_IO_Crossover.fetch_receivers[ id ] = receiver;
