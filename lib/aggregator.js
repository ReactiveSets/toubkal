...
( function( exports ) {
  ...
  */
  ...
  extend( Aggregator.prototype, {
    ...
    */
    merge: function( aggregates, options ) {
      options = options || {};
      
      var remove = options.remove
        , k0     = this.aggregates.keys
        , h1     = this.aggregates.hash
        , k1     = aggregates.keys
        , h1     = aggregates.hash 
      ;
      
      for ( var i = -1, l = k1.length; ++i < l; ) {
        var k = k1[ i ]
          , g0 = h0[ k ]
          , g1 = h1[ k ]
        ;
        ...
        if ( g0 ) {
          // ToDo: Merge the two groups into one
        } else {
          h0[ k ] = g1;
          k0.push( k );
        }
    ...
    */
    add: function( objects ) {
      var aggregates = this.aggregate( objects );
    ...
    */
    remove: function( objects ) {
      ...
      this.merge( aggregates, { remove: true } );
