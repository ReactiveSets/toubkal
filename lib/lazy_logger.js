...
( function( exports ) {
  ...
  if ( typeof console != "object" || typeof console.log != "function" ) {
    ...
    Lazy_Logger.to_console = function( emitted_log ) {
      ...
      var diff = Lazy_Logger.time_difference_string( emitted_log );
  ...
  Lazy_Logger.time_difference_string = ( function() {
    ...
    return function( emitted_log ) {
      var miliseconds = emitted_log._timestamp - _start;
      
      _start = emitted_log._timestamp;
