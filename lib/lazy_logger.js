...
*/
( this.umd_define || require( './umd_define' )( module, require ) )()
( 'lazy_logger', [ './console_logger' ], function( Console_Logger ) {
  "use strict";
  
  var lap_timer                = Console_Logger.lap_timer
    , lap_timer_string         = Console_Logger.lap_timer_string
    , date_to_timestamp_string = Console_Logger.date_to_timestamp_string
    , de = false
  ...
  function to_console_parameters( t ) {
    var parameters = [
        date_to_timestamp_string( t._timestamp )
      + ' #' + t._level
      + ' ' + t._realm
      + '[ ' + t._name
      + ' ].' + t._method + '()'
