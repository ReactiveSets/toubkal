  ...
  */
  Load_Images.build( 'bootstrap_carousel', Bootstrap_Carousel, {
    ...
    set_events_handlers: function() {
      ...
      $( carousel )
        .mousemove( function() { // console.log( 'carousel mousemove', e.pageX, e.pageY );
          show_box();
          
          timer = setTimeout( hide_box, 1500 );
        } )
        .mouseleave( hide_box )
      ;
      ...
      function show_box() { clearTimeout( timer ); $( _controls ).fadeIn (  400 ); }
      function hide_box() { clearTimeout( timer ); $( _controls ).fadeOut( 1000 ); }
    }, // set_events_handlers()
