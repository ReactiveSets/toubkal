  ...
  Load_Images.build( 'bootstrap_carousel', Bootstrap_Carousel, {
    ...
    set_events_handlers: function() {
      var that      = this
        ...
        , timer     = null, show_controls = false
      ;
      ...
      $( carousel )
        ...
        .mousemove( function( e ) {
          ...
          if( ! show_controls ) timer = setTimeout( hide_box, 1500 );
        } )
      ;
      
      $( _controls )
        .mouseenter( function() { show_controls = true;  } )
        .mouseleave( function() { show_controls = false; } )
      ;
