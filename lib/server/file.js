      ...
      _add_value: function( t, file ) {
        ...
        if ( d ) {
          if ( d.error ) {
            ...
            return Super._add_value.call( that, t, file );
          } else if ( d.success ) {
            return Super._add_value.call( that, t, file );
          }
          ...
          d = this._directories[ dirname ] = { files: [] };
        }
        ...
        make_directory( dirname, function( error ) {
          ...
          if ( l > 1 ) t.add_operations( 1 - l ); // Remove l - 1 operations
          
          Super._add_values.call( that, t, files );
