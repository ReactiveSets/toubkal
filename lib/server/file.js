  ...
  File_Set.Build( 'watch', Watch, function( Super ) { return {
    _add_value: function( t, file ) {
      ...
      if ( this._removed( file ) ) {
        // Need to update this file, or do nothing if this is only a non-content change
        return this;
      }
    ...
    _remove_value: function( t, file ) {
      if ( ! t.source_more && ( file = this._remove_file( file ) ) ) {
    ...
    return {
      _add_value: function( t, directory ) {
        ...
        function check_done() {
          ...
          // Prevent re-use of transaction, forces to allocate new transaction if transaction is complete
          t.is_closed() && ( t = null );
        } // check_done()
      }, // _add_value()
