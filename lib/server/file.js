...
Pipelet.Compose( 'configuration', function( source, options ) {
  options = extend_2( {
    flow: 'configuration', filepath: '~/config.rs.json'
  }, options );
  ...
  de&&ug( 'configuration(), normalized_path:', normalized_path );
  
  var configuration = configurations[ normalized_path ];
  
  if ( configuration ) return configuration;
  
  de&&ug( 'configuration(), creating instance, options:', options );
