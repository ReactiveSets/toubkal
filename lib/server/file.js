...
( function( exports ) {
  ...
  */
  function Watch( options ) {
    options = Set.call( this, [], extend( {}, options, { key: [ 'name' ] } ) )._options;
  ...
  Set.Build( 'watch', Watch, function( Super ) { return {
  ...
  */
  function Watch_Directories( options ) {
    Watch.call( this, extend( {}, options, { key: [ 'path' ] } ) );
    
    return this;
  } // Watch_Directories()
  
  Watch.Build( 'watch_directories', Watch_Directories, function( Super ) {
    return {
      _add_value: function( t, v ) {
        var path    = this._get_path( v.path )
