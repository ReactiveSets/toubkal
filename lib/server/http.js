            ...
            .on( 'connection', function( socket ) {
              ...
              .on( 'xs_connection', function( _connection ) {
                ...
                if ( connection ) {
                  ...
                  connections[ id ] = connection = { id: id, state: 'connected', socket: new XS.Socket_IO_Socket( socket ) };
                ...
                connection.socket.connect(); // allow xs socket to emit operations
              } ) // on xs_connection
