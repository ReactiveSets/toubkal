  ...
  /* --------------------------------------------------------------------------
     ...
     Parameters:
       - options:
         ...
         - cache_control_max_age: Cache control, default max age is Serve.max_age
           (1 hour) to avoid fetching the same asset twice in the same session, yet
