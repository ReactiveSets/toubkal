          ...
          server: socketio
            ...
            .on( 'connection', function( socket ) {
              ...
              .on( 'xs_connection', function( _connection ) {
                de&&ug( 'socket_io_server(), received xs_connection: ' + log.s( _connection ) );
                ...
                if ( ! connection ) {
                  ...
                  id = ++that.last_connection_id;
                  
                  connections[ id ] = connection = { id: id, state: 'connected', socket: socket };
              ...
              .on( 'xs', function( data ) {
                de&&ug( 'socket_io_servers(), received xs data: ' + log.s( data ) );
              } );
