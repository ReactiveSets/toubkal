...
rs
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      ...
      with credentials and lookup_user() function. Emits successfuly
      configured strategies stripped of credentials and lookup_user().
      ...
      - Pipelet trace()
  */
  .Singleton( 'passport_strategies', function( source, _, options ) {
    const
      rs = source.namespace(),
      ...
      .map( function( fetched ) {
        ...
        transaction.updates = updates && updates
          ...
          .filter( ( update ) => {
            ...
            if ( position != -1 ) return true; // will update existing strategy
        ...
        function add_strategy( strategy ) {
          ...
          function user_lookup() {
            ...
            args.unshift( user_lookup_and_create( strategy.name ) );
        ...
        function emit_strategy( strategy ) {
          ...
          // remove credentials and lookup_user()
...
rs
  /* --------------------------------------------------------------------------
      ...
      - Pipelet trace()
  */
  .Compose( 'passport_strategies_routes', function( source, passport_instance, options ) {
    const
    ...
    passport_instance.api.fetch( function( values ) {
      ...
      if ( instance ) passport_lib_instance = instance;
    } );
    ...
    return source
      ...
      .flat_map( function( strategy ) {
        ...
        function authenticate_handler( options ) {
          return passport_lib_instance.authenticate( strategy_name, options );
