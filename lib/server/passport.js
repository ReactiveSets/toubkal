...
Set.Build( 'passport_strategies', Passport_Strategies, function ( Super ) { return {
  _add_value: function( t, strategy ) {
    ...
    Super._add_value.call( this, t, extend( {}, strategy, { Strategy: Strategy, parameters: parameters } ) );
  ...
  _remove_value: function( t, strategy ) {
    var position = this._index_of( strategy );
    
    if ( position != -1 ) {
      Super._remove_value.call( this, t, this.a[ position ] );
    } else {
      t.emit_nothing();
    }
  }, // _remove_value()
