...
/* -------------------------------------------------------------------------------------------
    ...
    - Pipelet trace()
*/
// ToDo: make passport_strategies_configuration() a source-scoped singleton
rs.Compose( 'passport_strategies_configuration', function( source, callback_base, options ) {
  return source
    // read / write the config files
    // ToDo: default configuration should be read from application directory passport.rs.json
