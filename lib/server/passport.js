      ...
      return function( profile, done ) {
        ...
        function lookup_and_create( user_profiles ) {
          ...
          if ( l == 0 ) {
            ...
            // ToDo: this code is application-specific
            user = {
              flow         : flow,
              id           : uuid_v4(),
...
function Passport( users, options ) {
  ...
  this._routes          = {};
  this._user_flow       = options.user_flow || 'user_profile';
  ...
  function deserialize( user_id, done ) {
    ...
    users._fetch_all( rx, [ { flow: flow, id: user_id } ] );
    
    function rx( user_profiles ) {
