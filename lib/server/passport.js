...
var rs       = require( 'toubkal' )
  ...
  // For now we still use a single instance
  // ToDo: refactor passport.js using multitons or scope-namespaced-singletons to allow multiple servers
  , passport = RS.passport = new Passport()
