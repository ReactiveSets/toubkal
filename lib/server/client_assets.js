...
rs
  ...
  */
  ...
  /* --------------------------------------------------------------------------
      @pipelet build_bundles( base, www_base, options )
      
      @short Provides minified bundles from base/bundles.json configuration
      
      @parameters
      - **base** \\<String>: path to base directory to locate bundle, this
        is typically ```__dirname```.
      
      - **www_base**: base directory for public files, aka www root
        directory. In can be dedined as a:
          - \\<String>: path of www base
          - \\<String []>: path elements to www base, typically
            ```[ __dirname, "www" ]```.
      
      - **options** \\<Object>:
        - **bundles_json** \\<String>: name of json bundle file in *base*,
  ...
  */
  .Compose( "build_bundles", function( source, base, www, options ) {
