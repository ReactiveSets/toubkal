...
var File_Set = RS.File_Set;

/* -------------------------------------------------------------------------------------------
   de&&ug()
*/
var de = false, ug = log.bind( null, 'thumbnails' );
...
rs.Compose( 'thumbnails', function( source, options ) {
  // set default options
...
/* -------------------------------------------------------------------------------------------
   create_thumbnails( options )
*/
File_Set.Build( 'create_thumbnails', _Thumbnails, function( Super ) { return {
  _add_value: function( transaction, file ) {
    var that   = this
      , width  = this._width , height = this._height
      , crop_x = this._crop_x, crop_y = this._crop_y
      
      , image_path     = this._path_join( file.image_path )
      , thumbnail_path = this._path_join( file.path       )
    ;
  ...
  _remove_value: function( t, file ) {
    var that = this, thumbnail_path = this._path_join( file.path );
