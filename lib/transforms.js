...
!function( exports ) {
  ...
  */
  ...
  /* -------------------------------------------------------------------------------------------
     source.content_to_set( [ options ] )

     This is a stateless and lazy pipelet.

     Source:
       - content (Object): the value to output to destination

     Destination:
       - all attributes of content
     ...
     ToDo: content_to_set(), add tests
  */
  Alter.Build( 'content_to_set', function( options ) {
      return Alter.call( this
        , function( v ) { return v.content }
