...
( function( exports ) {
  ...
  */
  ...
  function ug( m ) {
    log( "xs boostrap_photo_album.js, " + m );
  } // ug()
  ...
  */
  XS.Compose( 'boostrap_photo_album', function( source, photos_matrix_node, carousel_node, options ) {
    ...
    var thumbnails_events = source
      ...
      .load_images()
      .boostrap_photos_matrix( photos_matrix_node, { input_events: carousel_events } )
    ...
    return source
      ...
      .load_images()
      .boostrap_carousel( carousel_node, { input_events: thumbnails_events } )
