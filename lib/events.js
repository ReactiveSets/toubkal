...
( function( exports ) {
  ...
  */
  XS.Compose( 'timestamp', function( source, options ) {
    return source.alter( alter_timestamp, options );
    
    function alter_timestamp( value ) {
      return value.timestamp? value : extend( { timestamp: timestamp() }, value );
    }
  } );
  ...
  */
  XS.Compose( 'events_metadata', function( source, options ) {
    ...
    options.others && extend( o, options.others );
    
    return source.alter( alter_event, options );
