  ...
  */
  ...
  extend( Control.Radio.prototype, {
    select_node : function() {
      var radios = this.node.getElementsByTagName( "input" )
        , index  = this.selected_index
      ;
      
      for( var i = radios.length; i; ) radios[ --i ].checked = i === index;
    ...
    update_: function( at, value ) {
      ...
      if( u0.id    !== u1.id    ) div.firstChild.setAttribute( "name", u1.id );
      if( u0.label !== u1.label ) div.lastChild.innerText = u1.label;
