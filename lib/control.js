    ...
    insert_: function( at, value ) {
      ...
      function click() {
        var previous = that.value
          , index    = that.index_of( { id: to_value( this.value ) } )
        ;
        
        if( index !== that.selected_index && index !== -1 ) {
          var value = that.value = that.a[ that.selected_index = index ];
