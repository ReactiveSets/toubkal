...
( function( exports ) {
  ...
  Single_Choice.build( 'checkbox', Control.Checkbox, {
    ...
    insert_: function( at, value ) {
      ...
      if( l === 0 || value.selected ) {
        ...
        this.label.innerText  = this.options.label || value.label;
      }
    ...
    remove_: function( from, value ) {
      ...
      this.label.innerText  = a.length ? this.options.label || a[ 0 ].label : "";
    ...
    update_: function( at, value ) {
      ...
      if( v.id === u0.id ) {
        ...
        if( u0.label !== u1.label ) this.label.innerText  = this.options.label || u1.label
      }
  ...
  */
  ...
  Multiple_Choice.build( 'checkbox_group', Control.Checkbox_Group, {
    add: function( objects ) {
      ...
      Order.prototype.add.call( this, added );
      ...
      function toggle() {
        ...
        for( var i = l; i; ) {
          ...
          if( o.id == this.getAttribute( "name" ) ) {
            this.checked ? Order.prototype.add.call( that, [ o ] ) : Order.prototype.remove.call( that, [ o ] );
          }
        }
      } // toggle()
    }, // add()
    ...
    remove: function( objects ) {
      ...
      Order.prototype.remove.call( this, objects );
    ...
    update: function( updates ) {
      ...
      Order.prototype.remove.call( this, removed );
      Order.prototype.add   .call( this, added   );
      Order.prototype.update.call( this, updates );
  ...
  */
  ...
  Single_Choice.build( 'drop_down', Drop_Down, {
    ...
    get_value : function() {
      var v = this.a[ this.select.selectedIndex ];
    ...
    insert_: function( at, value ) {
      ...
      select.add( option, select.options[ at ] );
    ...
    update_: function( at, value ) {
      ...
      if( u0.label !== u1.label ) option.innerText = u1.label;
