...
( function( exports ) {
  ...
  */
  Control.Checkbox = function( node, options ) {
    de&&ug( this._get_name( 'new' ) + 'options: ' + log.s( options ) );
  ...
  Single_Choice.Build( 'checkbox', Control.Checkbox, {
    ...
    bind: function() {
      ...
      this.checkbox.onclick = function() {
        ...
        that.label.innerHTML = that._options.label || value.label;
    ...
    insert_: function( at, value ) {
      ...
      if( l === 0 || value.selected ) {
        ...
        this.label.innerHTML  = this._options.label || value.label;
      }
    ...
    remove_: function( from, value ) {
      ...
      this.label.innerHTML  = a.length ? this._options.label || a[ 0 ].label : "";
    ...
    update_: function( at, value ) {
      ...
      if( v.id    !== u.id    ) this.checkbox.checked = u.id;
      if( v.label !== u.label ) this.label.innerHTML  = this._options.label || u.label
