...
( function( exports ) {
  ...
  */
  ...
  extend( Filter.prototype, {
    add: function( objects ) {
      var filter = this.filter = XS.Code.decompile( this.filter )
  ...
  */
  ...
  p.add = p.remove = p.update = function() {
    ...
    var code = new XS.Code( 'organizer' )
  ...
  */
  eval( export_code( 'XS', [
    ...
    'extend', 'log', 'subclass', 'export_code'
  ] ) );
