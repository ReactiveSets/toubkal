...
[![Travis CI Build Status](https://travis-ci.org/ConnectedSets/ConnectedSets.png?branch=master)](https://travis-ci.org/ConnectedSets/ConnectedSets) *371 tests*
...
We have curently developped 371 automated tests for the XS core pipelets that run after every
...
-> passed 371 of 371 tests (4196ms)
#
