...
[![Travis CI Build Status](https://travis-ci.org/ConnectedSets/ConnectedSets.png?branch=master)](https://travis-ci.org/ConnectedSets/ConnectedSets) *374 tests*
...
We have curently developped 374 automated tests for the XS core pipelets that run after every
...
-> passed 374 of 374 tests (4196ms)
#
