...
[![Travis CI Build Status](https://travis-ci.org/ConnectedSets/ConnectedSets.png?branch=master)](https://travis-ci.org/ConnectedSets/ConnectedSets) *431 tests*
...
We have curently developped 431 automated tests for the XS core pipelets that run after every
...
-> passed 431 of 431 tests (4196ms)
#
