...
[![Travis CI Build Status](https://travis-ci.org/ConnectedSets/ConnectedSets.png?branch=master)](https://travis-ci.org/ConnectedSets/ConnectedSets) *451 tests*
...
We have curently developped 451 automated tests for the XS core pipelets that run after every
...
-> passed 451 of 451 tests (4196ms)
#
