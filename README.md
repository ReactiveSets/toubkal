...
[![Travis CI Build Status](https://travis-ci.org/ConnectedSets/ConnectedSets.png?branch=master)](https://travis-ci.org/ConnectedSets/ConnectedSets) *494 tests*
...
We have curently developped 494 automated tests for the XS core pipelets that run after every
...
-> passed 494 of 494 tests (4196ms)
#
